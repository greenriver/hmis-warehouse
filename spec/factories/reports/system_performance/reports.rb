FactoryBot.define do
  ...
  factory :spm_measure_six_fy2019, class: 'Reports::SystemPerformance::Fy2019::MeasureSix' do
    name { 'SPM Measure Six' }
  end

  factory :spm_measure_seven_fy2019, class: 'Reports::SystemPerformance::Fy2019::MeasureSeven' do
    name { 'SPM Measure Seven' }
  end
end
