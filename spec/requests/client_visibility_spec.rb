...
RSpec.describe ClientsController, type: :request, vcr: { cassette_name: 'client_visibility_spec' } do
  ...
  configs_variations.each do |variation|
    ...
    context 'when config s is in effect' do
      ...
      let!(:config) { create :config_s, variation }
      let!(:user) { create :user }
    ...
    context 'when config 3c is in effect' do
      ...
      let!(:config) { create :config_3c, variation }
      let!(:user) { create :user }
    ...
    context 'when config tc is in effect' do
      ...
      let!(:config) { create :config_tc, variation }
      let!(:user) { create :user }
    ...
    context 'when config ma is in effect' do
      ...
      let!(:config) { create :config_ma, variation }
      let!(:user) { create :user }
    ...
    context 'when config mi is in effect' do
      ...
      let!(:config) { create :config_mi, variation }
      let!(:user) { create :user }
