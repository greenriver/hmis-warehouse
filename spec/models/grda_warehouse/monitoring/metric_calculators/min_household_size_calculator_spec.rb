...
RSpec.describe GrdaWarehouse::Monitoring::MetricCalculators::MinHouseholdSizeCalculator, type: :model do
  ...
  describe '.calculate_batch' do
    ...
    context 'when client has multiple households of different sizes' do
      ...
      it 'returns minimum household size' do
        result = described_class.calculate_batch(
          [dest_client1],
          calculation_date,
        )
