...
RSpec.describe GrdaWarehouse::WarehouseReports::Project::DataQuality::VersionFour, type: :model do
  ...
  describe 'project data quality V4' do
    ...
    describe 'a single project report' do
      ...
      it 'exits to ph' do
        source_clients = exiting_clients.where(ex_t[:Destination].in(Hud.util.permanent_destinations))
        exits = @report.enrollments.exited.where(destination_id: Hud.util.permanent_destinations)
