...
RSpec.describe Health::FlagIneligiblePatientsJob, type: :model do
  ...
  let!(:patient_04) { create :patient, medicaid_id: 'ID04' } # EB 1, EB L, in fixture
  ...
  it 'flags managed patients' do
    ...
    expect(Health::Patient.program_ineligible).to include patient_02, patient_04, patient_06
