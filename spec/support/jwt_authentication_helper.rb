...
module JwtAuthenticationHelper
  ...
  # Replaces Devise's sign_out, which spec/rails_helper.rb withholds on the JWT arm. The unused user
  # argument keeps `sign_out(user)` call sites working on both arms.
