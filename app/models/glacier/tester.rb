...
module Glacier
  class Tester
    ...
    def chunk_size!
      ...
      raise "A non-power of two number of megs shouldn't be allowed" if @here
    ...
    def two_mb!
      ...
      raise 'Fail on 2MB, two chunks' if shas != ['9a76810f3694d29d82ce09051797834d443c4fb7b240fa8317315411351d4b81', '3e2187e09ee37247f5d7c7fea30f58c34b337aeecc814cbcd0c8689944b135e3']

      raise 'Fail on 2MB final digest' if chunker.digest != full_tree_hash
    ...
    def four_mb!
      ...
      chunker.each_chunk do |chunk|
        raise 'Fail on 4 meg, single chunk' if chunk.digest != full_tree_hash
      end

      raise 'Fail on 4MB final digest' if chunker.digest != full_tree_hash
