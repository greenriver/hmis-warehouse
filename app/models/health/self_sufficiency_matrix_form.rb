module Health
  class SelfSufficiencyMatrixForm < HealthBase
    ...
    SECTION_NOTES = {
      ...
      food: 'Please include the following information: Type of limitation if score is a (1)',
      ...
      safety: 'Please include the following information: Areas the guest has disclosed that currently influence the level of safety if score is 2 or below.',
