...
module ArelHelper
  ...
  included do
    ...
    # Table calls
    delegate :she_t, :shs_t, :shsm_t, :s_t, :g_t, :e_t, :ec_t, :ex_t, :ds_t, :c_t, :cn_t, :p_t, :pc_t, :o_t, :i_t, :af_t, :as_t, :asq_t, :ev_t, :ch_t, :hc_t, :wc_t, :wcp_t, :ib_t, :d_t, :hdv_t, :f_t, :cls_t, :enx_t, :hmis_form_t, :hmis_c_t, :c_client_t, :c_c_change_t, :yib_t, :vispdat_t, :hp_t, :hpr_t, :hapr_t, :hqa_t, :hpf_t, :hpff_t, :h_ssm_t, :h_epic_ssm_t, :h_sdhcmn_t, :h_ehs_t, :h_ecn_t, :h_cha_t, :h_echa_t, :h_rf_t, :h_cp_t, :htca_t, :htco_t, :h_sd_t, :r_monthly_t, :hr_ri_t, :r_t, :ag_t, :collection_t, :ug_t, to: 'self.class'
