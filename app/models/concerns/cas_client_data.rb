  ...
  included do
    ...
    def self.cas_columns_data
      @cas_columns_data ||= {
        ...
        sync_with_cas: { title: _('Available for matching in CAS') },
        dmh_eligible: { title: _('DMH Eligible') },
        va_eligible: { title: _('VA Eligible') },
        hues_eligible: { title: _('HUES Eligible') },
        hiv_positive: { title: _('HIV+') },
        chronically_homeless_for_cas: { title: _('Chronically Homeless for CAS') },
        us_citizen: { title: _('U.S Citizen or Permanent Resident') },
        asylee: { title: _('Asylee, Refugee') },
        ineligible_immigrant: { title: _('Ineligible Immigrant (Including Undocumented)') },
        lifetime_sex_offender: { title: _('Life-Time Sex Offender') },
        meth_production_conviction: { title: _('Meth Production Conviction') },
        family_member: { title: _('Part of a family') },
        child_in_household: { title: _('Children under age 18 in household') },
        ha_eligible: { title: _('Housing Authority Eligible') },
        cspech_eligible: { title: _('CSPECH Eligible') },
        congregate_housing: { title: _('Willing to live in congregate housing') },
        sober_housing: { title: _('Appropriate for sober supportive housing') },
        requires_wheelchair_accessibility: { title: _('Requires wheelchair accessible unit') },
        required_number_of_bedrooms: { title: _('Minimum number of bedrooms') },
        required_minimum_occupancy: { title: _('Minimum occupancy') },
        requires_elevator_access: { title: _('Requires ground floor unit or elevator access') },
        cas_match_override: { title: _('Override CAS Match Date') },
        vash_eligible: { title: _('VASH Eligible') },
        health_prioritized: { title: _('Health Priority') },
        tie_breaker_date: { title: _('Tie Breaker Date') },
        financial_assistance_end_date: { title: _('Financial Assistance End Date') },
        strengths: { title: _('Strengths') },
        challenges: { title: _('Challenges') },
        foster_care: { title: _('Foster care as youth') },
        open_case: { title: _('Current open case') },
        housing_for_formerly_homeless: { title: _('Prefers housing for formerly homeless') },
        drug_test: { title: _('Able to pass a drug test') },
        heavy_drug_use: { title: _('History of heavy drug use') },
        sober: { title: _('Clean/sober for at least one year') },
        willing_case_management: { title: _('Willing to engage with housing case management') },
        employed_three_months: { title: _('Employed for 3 or more months') },
        living_wage: { title: _('Earning a living wage ($13 or more)') },
      }
    end
