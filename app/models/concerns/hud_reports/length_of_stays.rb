...
module HudReports::LengthOfStays
  ...
  included do
    ...
    private def approximate_time_to_move_in(enrollment, reporting_age, hoh_enrollment)
      ...
      valid_ph_project_types = ::Hud.util.permanent_housing_project_types - [::Hud.util.project_type_brief('PH - OPH', true)]
      valid_ph_enrollment = enrollment.project_type.in?(valid_ph_project_types)
      other_pay_for_success = enrollment.project_type.in?([::Hud.util.project_type_brief('Other', true)]) && enrollment.project.pay_for_success?
