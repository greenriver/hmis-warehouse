...
module Importers::HMIS2020
  class Base
    ...
    def clean_source_file destination_path:, read_from:, klass:
      ...
      csv.drop(1).each do |row|
        begin
          ...
          if @deidentified && klass.name == 'GrdaWarehouse::Import::HMIS2020::Client'
    ...
    def self.affiliation_source
      GrdaWarehouse::Import::HMIS2020::Affiliation
    end
    ...
    def self.client_source
      GrdaWarehouse::Import::HMIS2020::Client
    end
    def client_source
    ...
    def self.disability_source
      GrdaWarehouse::Import::HMIS2020::Disability
    end
    ...
    def self.employment_education_source
      GrdaWarehouse::Import::HMIS2020::EmploymentEducation
    end
    ...
    def self.enrollment_source
      GrdaWarehouse::Import::HMIS2020::Enrollment
    end
    ...
    def self.enrollment_coc_source
      GrdaWarehouse::Import::HMIS2020::EnrollmentCoc
    end
    ...
    def self.exit_source
      GrdaWarehouse::Import::HMIS2020::Exit
    end
    def exit_source
    ...
    def self.export_source
      GrdaWarehouse::Import::HMIS2020::Export
    end
    def export_source
    ...
    def self.funder_source
      GrdaWarehouse::Import::HMIS2020::Funder
    end
    def funder_source
    ...
    def self.health_and_dv_source
      GrdaWarehouse::Import::HMIS2020::HealthAndDv
    end
    ...
    def self.income_benefits_source
      GrdaWarehouse::Import::HMIS2020::IncomeBenefit
    end
    ...
    def self.inventory_source
      GrdaWarehouse::Import::HMIS2020::Inventory
    end
    ...
    def self.organization_source
      GrdaWarehouse::Import::HMIS2020::Organization
    end
    ...
    def self.project_source
      GrdaWarehouse::Import::HMIS2020::Project
    end
    def project_source
    ...
    def self.project_coc_source
      GrdaWarehouse::Import::HMIS2020::ProjectCoc
    end
    ...
    def self.service_source
      GrdaWarehouse::Import::HMIS2020::Service
    end
    def service_source
