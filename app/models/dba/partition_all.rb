class DBA::PartitionAll
  TABLES = %w[
    ...
    hmis_2022_youth_education_statuses hmis_csv_2022_affiliations
    hmis_csv_2022_assessment_questions hmis_csv_2022_assessment_results
    hmis_csv_2022_assessments hmis_csv_2022_clients
    hmis_csv_2022_current_living_situations hmis_csv_2022_disabilities
    hmis_csv_2022_employment_educations hmis_csv_2022_enrollment_cocs
    hmis_csv_2022_enrollments hmis_csv_2022_events hmis_csv_2022_exits
    hmis_csv_2022_exports hmis_csv_2022_funders hmis_csv_2022_health_and_dvs
