...
module CohortColumns
  class AdjustedDaysHomelessLastThreeYears < ::CohortColumns::Integer
    ...
    attribute :description_translation_key, String, lazy: true, default: 'Days homeless in past 3 years for the client as calculated when added to the cohort (ES, SH, SO, or TH  with no overlapping TH or PH)'
