...
module CohortColumns
  class OngoingTh < ReadOnly
    ...
    def value(cohort_client) # OK
      return nil unless cohort_client.client.processed_service_history&.cohorts_ongoing_enrollments_th

      # in the form [['Project Name', 'last date']]
      cohort_client.client.processed_service_history.cohorts_ongoing_enrollments_th.
        sort do |a, b|
