...
module CohortColumns
  class OngoingPsh < ReadOnly
    ...
    def value(cohort_client) # OK
      return nil unless cohort_client.client.processed_service_history&.cohorts_ongoing_enrollments_psh

      # in the form [['Project Name', 'last date']]
      cohort_client.client.processed_service_history.cohorts_ongoing_enrollments_psh.
        sort do |a, b|
