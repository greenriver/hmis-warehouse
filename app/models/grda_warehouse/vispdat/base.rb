...
module GrdaWarehouse::Vispdat
  class Base < GrdaWarehouseBase
    ...
    ['attacked', 'threatened', 'legal', 'tricked', 'risky', 'owe_money', 'get_money', 'activities', 'basic_needs', 'abusive', 'leave', 'chronic', 'hiv', 'disability', 'avoid_help', 'pregnant', 'eviction', 'drinking', 'mental', 'head', 'learning', 'brain', 'medication', 'sell', 'trauma', 'picture'].each do |field|
    ...
    ['homeless', 'episodes_homeless', 'emergency_healthcare', 'ambulance', 'inpatient', 'crisis_service', 'talked_to_police', 'jail'].each do |field|
    ...
    def notify_vispdat_completed
      NotifyUser.vispdat_completed(id).deliver_later if vispdat_completed?
    end
