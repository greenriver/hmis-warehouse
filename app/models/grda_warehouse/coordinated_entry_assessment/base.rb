  ...
  class Base < GrdaWarehouseBase
    ...
    def self.detail_columns
      @detail_columns ||= {
        ...
        Translation.translate('Location Option 1') => [:assessment, :location_option_1],
        Translation.translate('Location Option 2') => [:assessment, :location_option_2],
        Translation.translate('Location Option 3') => [:assessment, :location_option_3],
        Translation.translate('Location Option 4') => [:assessment, :location_option_4],
