...
module GrdaWarehouse::YouthIntake
  class Base < GrdaWarehouseBase
    ...
    def race_array
      ...
      client_race&.map { |r| ::HudHelper.util.race(r).presence }&.compact
    end

    def gender
      ::HudHelper.util.gender(client_gender)
    end
    ...
    def update_destination_client
      ...
      gender_column = ::HudHelper.util.gender_id_to_field_name[client_gender]
