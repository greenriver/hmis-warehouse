...
module GrdaWarehouse::Census
  class ProjectBatch
    ...
    def build_census_batch
      ...
      add_clients_to_census_buckets(get_parents_client_counts, :family_parents)
      ...
      add_clients_to_census_buckets(get_unaccompanied_minors_client_counts, :unaccompanied_minors)
    ...
    def get_parents_client_counts
      get_client_and_project_counts(GrdaWarehouse::ServiceHistoryEnrollment.family_parents)
    end
    ...
    def get_unaccompanied_minors_client_counts
      get_client_and_project_counts(GrdaWarehouse::ServiceHistoryEnrollment.unaccompanied_minors)
    end
