...
module GrdaWarehouse::Hud
  class Exit < Base
    ...
    composite_belongs_to :direct_client, **hud_assoc(:PersonalID, 'Client'), inverse_of: :direct_exits, optional: true
    composite_belongs_to :user, **hud_assoc(:UserID, 'User'), inverse_of: :exits, optional: true
    composite_belongs_to :export, **hud_assoc(:ExportID, 'Export'), inverse_of: :exits, optional: true
