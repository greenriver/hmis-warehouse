...
module GrdaWarehouse::Hud
  class EnrollmentCoc < Base
    ...
    composite_belongs_to :direct_client, **hud_assoc(:PersonalID, 'Client'), inverse_of: :direct_enrollment_cocs, optional: true
    composite_belongs_to :export, **hud_assoc(:ExportID, 'Export'), inverse_of: :enrollment_cocs, optional: true
    belongs_to :data_source
    composite_belongs_to :user, **hud_assoc(:UserID, 'User'), inverse_of: :enrollment_cocs, optional: true
