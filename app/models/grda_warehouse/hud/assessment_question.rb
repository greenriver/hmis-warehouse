...
module GrdaWarehouse::Hud
  class AssessmentQuestion < Base
    ...
    belongs_to_with_composite_keys :export, class_name: 'GrdaWarehouse::Hud::Export', keys: [:ExportID], inverse_of: :assessment_questions, optional: true
    ...
    belongs_to_with_composite_keys :user, class_name: 'GrdaWarehouse::Hud::User', keys: [:UserID], inverse_of: :assessment_questions, optional: true
