...
module GrdaWarehouse::Hud
  class YouthEducationStatus < Base
    ...
    composite_belongs_to :export, **hud_assoc(:ExportID, 'Export'), inverse_of: :youth_education_statuses, optional: true
    composite_belongs_to :user, **hud_assoc(:UserID, 'User'), inverse_of: :youth_education_statuses, optional: true
