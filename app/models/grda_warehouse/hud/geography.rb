...
module GrdaWarehouse::Hud
  class Geography < Base
    ...
    belongs_to_with_composite_keys :project_coc, class_name: 'GrdaWarehouse::Hud::ProjectCoc', keys: [:ProjectID, :CoCCode, :data_source_id], inverse_of: :geographies, optional: true
