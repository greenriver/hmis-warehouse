...
module GrdaWarehouse::Hud
  class HealthAndDv < Base
    ...
    composite_belongs_to :direct_client, **hud_assoc(:PersonalID, 'Client'), inverse_of: :direct_health_and_dvs, optional: true
    composite_belongs_to :export, **hud_assoc(:ExportID, 'Export'), inverse_of: :health_and_dvs, optional: true
    composite_belongs_to :user, **hud_assoc(:UserID, 'User'), inverse_of: :health_and_dvs, optional: true
