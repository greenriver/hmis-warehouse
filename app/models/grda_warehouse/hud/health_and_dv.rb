...
module GrdaWarehouse::Hud
  class HealthAndDv < Base
    ...
    belongs_to_with_composite_keys :enrollment_with_deleted, class_name: 'GrdaWarehouse::Hud::WithDeleted::Enrollment', keys: [:EnrollmentID, :PersonalID, :data_source_id], optional: true
