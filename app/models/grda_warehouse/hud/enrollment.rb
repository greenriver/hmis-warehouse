...
module GrdaWarehouse::Hud
  class Enrollment < Base
    ...
    composite_belongs_to :client, **hud_assoc(:PersonalID, 'Client'), inverse_of: :enrollments, optional: true
    composite_belongs_to :export, **hud_assoc(:ExportID, 'Export'), inverse_of: :enrollments, optional: true
    composite_belongs_to :project, **hud_assoc(:ProjectID, 'Project'), inverse_of: :enrollments, optional: true
