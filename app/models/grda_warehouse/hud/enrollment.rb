...
module GrdaWarehouse::Hud
  class Enrollment < Base
    ...
    def prior_living_situation_label
      Hud.util.living_situation(living_situation)
    end
    ...
    def new_episode?
      return false unless Hud.util.chronic_project_types.include?(project.ProjectType)

      thirty_days_ago = self.EntryDate - 30.days
      ninety_days_ago = self.EntryDate - 90.days

      non_homeless_residential = Hud.util.residential_project_type_ids - Hud.util.chronic_project_types
