module GrdaWarehouse::Hud
  class Enrollment < Base
    ...
    has_one :enrollment_coc_at_entry, -> {where(DataCollectionStage: 1)}, class_name: 'GrdaWarehouse::Hud::EnrollmentCoc', primary_key: [:ProjectEntryID, :PersonalID, :data_source_id], foreign_key: [:ProjectEntryID, :PersonalID, :data_source_id]
