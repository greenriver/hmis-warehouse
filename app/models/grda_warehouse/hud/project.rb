...
module GrdaWarehouse::Hud
  class Project < Base
    ...
    scope :viewable_by, ->(user, confidential_scope_limiter: :non_confidential, include_cocs: true) do
      query = if include_cocs
        viewable_by_entity(user)
      else
        viewable_by_entity_non_coc(user)
      end
    ...
    scope :viewable_by_entity_non_coc, ->(user) do
