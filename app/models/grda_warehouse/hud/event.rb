...
module GrdaWarehouse::Hud
  class Event < Base
    ...
    composite_belongs_to :export, **hud_assoc(:ExportID, 'Export'), inverse_of: :events, optional: true
    composite_belongs_to :user, **hud_assoc(:UserID, 'User'), inverse_of: :events, optional: true
