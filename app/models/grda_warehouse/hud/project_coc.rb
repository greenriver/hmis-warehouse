...
module GrdaWarehouse::Hud
  class ProjectCoc < Base
    ...
    has_many_with_composite_keys :geographies, class_name: 'GrdaWarehouse::Hud::Geography', keys: [:ProjectID, :CoCCode, :data_source_id], inverse_of: :project_coc
    has_many_with_composite_keys :inventories, class_name: 'GrdaWarehouse::Hud::Inventory', keys: [:ProjectID, :CoCCode, :data_source_id], inverse_of: :project_coc
