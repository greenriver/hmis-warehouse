...
module GrdaWarehouse::Hud
  class Affiliation < Base
    ...
    composite_belongs_to :project, **hud_assoc(:ProjectID, 'Project'), inverse_of: :affiliations, optional: true
    ...
    composite_belongs_to :export, **hud_assoc(:ExportID, 'Export'), inverse_of: :affiliations, optional: true
    composite_belongs_to :user, **hud_assoc(:UserID, 'User'), inverse_of: :affiliations, optional: true
