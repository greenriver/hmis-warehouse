...
module GrdaWarehouse::Hud
  class Service < Base
    ...
    scope :bed_night, -> { where(RecordType: HudUtilityCurrent.record_type('Bed Night', true)) }
    scope :not_bed_night, -> { where.not(RecordType: HudUtilityCurrent.record_type('Bed Night', true)) }
    scope :path_service, -> { where(RecordType: HudUtilityCurrent.record_type('PATH Service', true)) }
    scope :path_referral, -> { where(RecordType: HudUtilityCurrent.record_type('PATH Referral', true)) }
