  ...
  class StatsCalculator
    ...
    def most_recent_homeless_dates
      @most_recent_homeless_dates ||= begin
        ...
        dates = source.homeless.
          in_project_type(HudHelper.util.homeless_project_types). # for index hinting
    ...
    def homeless_counts
      @homeless_counts ||= begin
        ...
        non_homeless_sql = GrdaWarehouse::ServiceHistoryServiceMaterialized.
          ...
          where(shsm_a[:project_type].in(HudHelper.util.residential_project_type_numbers_by_code[:ph])). # for index hinting
        ...
        homeless_sql = GrdaWarehouse::ServiceHistoryServiceMaterialized.
          ...
          where(shsm_b[:project_type].in(HudHelper.util.homeless_project_types)). # for index hinting
    ...
    def all_literally_homeless_last_three_years
      @all_literally_homeless_last_three_years ||= begin
        ...
        non_homeless_sql = GrdaWarehouse::ServiceHistoryServiceMaterialized.
          ...
          where(shsm_a[:project_type].in(HudHelper.util.residential_project_type_numbers_by_code[:ph] + HudHelper.util.residential_project_type_numbers_by_code[:th])). # for index hinting
        ...
        homeless_sql = GrdaWarehouse::ServiceHistoryServiceMaterialized.
          ...
          where(shsm_b[:project_type].in(HudHelper.util.literally_homeless_project_types)). # for index hinting
    ...
    def most_recent_chronic_dates
      @most_recent_chronic_dates ||= GrdaWarehouse::ServiceHistoryServiceMaterialized.literally_homeless.
        in_project_type(HudHelper.util.literally_homeless_project_types). # for index hinting
        where(client_id: @client_ids).
        group(:client_id).
        maximum(:date)
    end
        ...
        GrdaWarehouse::ServiceHistoryEnrollment.entry.ongoing.
          ...
          pluck(:client_id, :project_type).each do |id, project_type|
            ...
            oe[id] << if project_type == 13
              ...
              [project_type, ::HudHelper.util.project_type_brief(project_type)]
            end
          end
      end
        ...
        GrdaWarehouse::ServiceHistoryEnrollment.where(client_id: @client_ids).
          ...
          each do |id, destination, other_destination, last_date_in_program, project_type|
            ...
            destination_string = if destination_code == 17
              ...
              ::HudHelper.util.destination(destination_code)
            end

            destinations[id] ||= []
            destinations[id] << "#{last_date_in_program} - Destination: #{destination_string}, from: #{::HudHelper.util.project_type_brief(project_type)}"
          end
      end
