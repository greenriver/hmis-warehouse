  ...
  def fake_patterns
    @fake_patterns ||= {
      ...
      CoCCode: ->(_value) do
        ...
        if rc
          HudUtilityCurrent.cocs.keys.select { |c| c.starts_with?(rc) }.sample
        else
          HudUtilityCurrent.cocs.keys.sample
        end
      end,
      ...
      SourceContactEmail: ->(_value) { Faker::Internet.email },
      ...
      UserEmail: ->(_value) { Faker::Internet.email },
