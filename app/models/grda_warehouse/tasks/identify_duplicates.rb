...
module GrdaWarehouse::Tasks
  class IdentifyDuplicates
    ...
    def source_clients_grouped_by_name
      @source_clients_grouped_by_name ||= all_source_clients.group_by { |first_name, last_name, _ssn, _dob, _dest_id| [first_name.downcase, last_name.downcase] }
    end

    def source_clients_grouped_by_ssn
      @source_clients_grouped_by_ssn ||= all_source_clients.group_by { |_first_name, _last_name, ssn, _dob, _dest_id| ssn }
    end

    def source_clients_grouped_by_dob
      @source_clients_grouped_by_dob ||= all_source_clients.group_by { |_first_name, _last_name, _ssn, dob, _dest_id| dob }
    end
