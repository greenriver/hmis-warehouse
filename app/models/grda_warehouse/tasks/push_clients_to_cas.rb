      ...
      @title_override.deep_merge!(
        {
          ...
          am_ind_ak_native: "Race: #{::HUD.races['AmIndAKNative']}",
          asian: "Race: #{::HUD.races['Asian']}",
          black_af_american: "Race: #{::HUD.races['BlackAfAmerican']}",
          native_hi_pacific: "Race: #{::HUD.races['NativeHIPacific']}",
          white: "Race: #{::HUD.races['White']}",
          female: "Gender: #{::HUD.genders[0]}",
          male: "Gender: #{::HUD.genders[1]}",
          no_single_gender: "Gender: #{::HUD.genders[4]}",
          transgender: "Gender: #{::HUD.genders[5]}",
          questioning: "Gender: #{::HUD.genders[6]}",
        },
      )
