        ...
        client_scope.in_batches do |batch|
          ...
          batch.find_each do |client|
            ...
            row += [
              ...
              Hud.util.residence_prior_length_of_stay(report_calculator.enrollment_for_client(client)&.LengthOfStay),
              report_calculator.income_for_client(client)&.TotalMonthlyIncome,
              report_calculator.income_for_client(client)&.EarnedAmount,
              Hud.util.disability_response(report_calculator.physical_disability_for_client(client)&.DisabilityResponse),
              Hud.util.no_yes_reasons_for_missing_data(report_calculator.physical_disability_for_client(client)&.IndefiniteAndImpairs),
              Hud.util.disability_response(report_calculator.developmental_disability_for_client(client)&.DisabilityResponse),
              Hud.util.no_yes_reasons_for_missing_data(report_calculator.developmental_disability_for_client(client)&.IndefiniteAndImpairs),
              Hud.util.disability_response(report_calculator.chronic_disability_for_client(client)&.DisabilityResponse),
              Hud.util.no_yes_reasons_for_missing_data(report_calculator.chronic_disability_for_client(client)&.IndefiniteAndImpairs),
              Hud.util.disability_response(report_calculator.hiv_disability_for_client(client)&.DisabilityResponse),
              Hud.util.no_yes_reasons_for_missing_data(report_calculator.hiv_disability_for_client(client)&.IndefiniteAndImpairs),
              Hud.util.disability_response(report_calculator.mental_disability_for_client(client)&.DisabilityResponse),
              Hud.util.no_yes_reasons_for_missing_data(report_calculator.mental_disability_for_client(client)&.IndefiniteAndImpairs),
              Hud.util.disability_response(report_calculator.substance_disability_for_client(client)&.DisabilityResponse),
              Hud.util.no_yes_reasons_for_missing_data(report_calculator.substance_disability_for_client(client)&.IndefiniteAndImpairs),
              Hud.util.no_yes_reasons_for_missing_data(report_calculator.health_for_client(client)&.DomesticViolenceSurvivor),
              Hud.util.sexual_orientation(report_calculator.enrollment_for_client(client)&.SexualOrientation),
              Hud.util.last_grade_completed(report_calculator.education_for_client(client)&.LastGradeCompleted),
              Hud.util.no_yes_reasons_for_missing_data(report_calculator.education_for_client(client)&.Employed),
              Hud.util.no_yes_reasons_for_missing_data(report_calculator.enrollment_for_client(client)&.FormerWardChildWelfare),
              Hud.util.no_yes_reasons_for_missing_data(report_calculator.enrollment_for_client(client)&.FormerWardJuvenileJustice),
              Hud.util.no_yes_reasons_for_missing_data(report_calculator.exit_for_client(client)&.ExchangeForSex),
              Hud.util.no_yes_reasons_for_missing_data(report_calculator.exit_for_client(client)&.WorkPlaceViolenceThreats),
              Hud.util.no_yes_reasons_for_missing_data(report_calculator.exit_for_client(client)&.DestinationSafeClient),
