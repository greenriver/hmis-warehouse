        ...
        client_scope.in_batches do |batch|
          ...
          batch.find_each do |client|
            ...
            row << [
              ...
              HudUtility2024.residence_prior_length_of_stay(report_calculator.enrollment_for_client(client)&.LengthOfStay),
              report_calculator.income_for_client(client)&.TotalMonthlyIncome,
              report_calculator.income_for_client(client)&.EarnedAmount,
              HudUtility2024.disability_response(report_calculator.physical_disability_for_client(client)&.DisabilityResponse),
              HudUtility2024.no_yes_reasons_for_missing_data(report_calculator.physical_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtility2024.disability_response(report_calculator.developmental_disability_for_client(client)&.DisabilityResponse),
              HudUtility2024.no_yes_reasons_for_missing_data(report_calculator.developmental_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtility2024.disability_response(report_calculator.chronic_disability_for_client(client)&.DisabilityResponse),
              HudUtility2024.no_yes_reasons_for_missing_data(report_calculator.chronic_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtility2024.disability_response(report_calculator.hiv_disability_for_client(client)&.DisabilityResponse),
              HudUtility2024.no_yes_reasons_for_missing_data(report_calculator.hiv_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtility2024.disability_response(report_calculator.mental_disability_for_client(client)&.DisabilityResponse),
              ...
              HudUtility2024.no_yes_reasons_for_missing_data(report_calculator.enrollment_for_client(client)&.FormerWardChildWelfare),
              HudUtility2024.no_yes_reasons_for_missing_data(report_calculator.enrollment_for_client(client)&.FormerWardJuvenileJustice),
              HudUtility2024.no_yes_reasons_for_missing_data(report_calculator.exit_for_client(client)&.ExchangeForSex),
              HudUtility2024.no_yes_reasons_for_missing_data(report_calculator.exit_for_client(client)&.WorkPlaceViolenceThreats),
              HudUtility2024.no_yes_reasons_for_missing_data(report_calculator.exit_for_client(client)&.DestinationSafeClient),
