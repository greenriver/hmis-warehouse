        ...
        client_scope.in_batches do |batch|
          ...
          batch.find_each do |client|
            ...
            row += [
              ...
              client.gender,
              HudUtilityCurrent.veteran_status(client.VeteranStatus),
              ...
              HudUtilityCurrent.destination(report_calculator.exit_for_client(client)&.Destination),
              HudUtilityCurrent.living_situation(report_calculator.enrollment_for_client(client)&.LivingSituation),
              HudUtilityCurrent.residence_prior_length_of_stay(report_calculator.enrollment_for_client(client)&.LengthOfStay),
              report_calculator.income_for_client(client)&.TotalMonthlyIncome,
              report_calculator.income_for_client(client)&.EarnedAmount,
              HudUtilityCurrent.disability_response(report_calculator.physical_disability_for_client(client)&.DisabilityResponse),
              HudUtilityCurrent.no_yes_reasons_for_missing_data(report_calculator.physical_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtilityCurrent.disability_response(report_calculator.developmental_disability_for_client(client)&.DisabilityResponse),
              HudUtilityCurrent.no_yes_reasons_for_missing_data(report_calculator.developmental_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtilityCurrent.disability_response(report_calculator.chronic_disability_for_client(client)&.DisabilityResponse),
              HudUtilityCurrent.no_yes_reasons_for_missing_data(report_calculator.chronic_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtilityCurrent.disability_response(report_calculator.hiv_disability_for_client(client)&.DisabilityResponse),
              HudUtilityCurrent.no_yes_reasons_for_missing_data(report_calculator.hiv_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtilityCurrent.disability_response(report_calculator.mental_disability_for_client(client)&.DisabilityResponse),
              HudUtilityCurrent.no_yes_reasons_for_missing_data(report_calculator.mental_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtilityCurrent.disability_response(report_calculator.substance_disability_for_client(client)&.DisabilityResponse),
              HudUtilityCurrent.no_yes_reasons_for_missing_data(report_calculator.substance_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtilityCurrent.no_yes_reasons_for_missing_data(report_calculator.health_for_client(client)&.DomesticViolenceSurvivor),
              HudUtilityCurrent.sexual_orientation(report_calculator.enrollment_for_client(client)&.SexualOrientation),
              HudUtilityCurrent.last_grade_completed(report_calculator.education_for_client(client)&.LastGradeCompleted),
              HudUtilityCurrent.no_yes_reasons_for_missing_data(report_calculator.education_for_client(client)&.Employed),
              HudUtilityCurrent.no_yes_reasons_for_missing_data(report_calculator.enrollment_for_client(client)&.FormerWardChildWelfare),
              HudUtilityCurrent.no_yes_reasons_for_missing_data(report_calculator.enrollment_for_client(client)&.FormerWardJuvenileJustice),
              HudUtilityCurrent.no_yes_reasons_for_missing_data(report_calculator.exit_for_client(client)&.ExchangeForSex),
              HudUtilityCurrent.no_yes_reasons_for_missing_data(report_calculator.exit_for_client(client)&.WorkPlaceViolenceThreats),
              HudUtilityCurrent.no_yes_reasons_for_missing_data(report_calculator.exit_for_client(client)&.DestinationSafeClient),
