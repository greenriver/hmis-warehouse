        ...
        client_scope.in_batches do |batch|
          ...
          batch.find_each do |client|
            ...
            row << [
              ...
              HudUtility.residence_prior_length_of_stay(report_calculator.enrollment_for_client(client)&.LengthOfStay),
              report_calculator.income_for_client(client)&.TotalMonthlyIncome,
              report_calculator.income_for_client(client)&.EarnedAmount,
              HudUtility.disability_response(report_calculator.physical_disability_for_client(client)&.DisabilityResponse),
              HudUtility.no_yes_reasons_for_missing_data(report_calculator.physical_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtility.disability_response(report_calculator.developmental_disability_for_client(client)&.DisabilityResponse),
              HudUtility.no_yes_reasons_for_missing_data(report_calculator.developmental_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtility.disability_response(report_calculator.chronic_disability_for_client(client)&.DisabilityResponse),
              HudUtility.no_yes_reasons_for_missing_data(report_calculator.chronic_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtility.disability_response(report_calculator.hiv_disability_for_client(client)&.DisabilityResponse),
              HudUtility.no_yes_reasons_for_missing_data(report_calculator.hiv_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtility.disability_response(report_calculator.mental_disability_for_client(client)&.DisabilityResponse),
              HudUtility.no_yes_reasons_for_missing_data(report_calculator.mental_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtility.disability_response(report_calculator.substance_disability_for_client(client)&.DisabilityResponse),
              HudUtility.no_yes_reasons_for_missing_data(report_calculator.substance_disability_for_client(client)&.IndefiniteAndImpairs),
              HudUtility.no_yes_reasons_for_missing_data(report_calculator.health_for_client(client)&.DomesticViolenceVictim),
              HudUtility.sexual_orientation(report_calculator.enrollment_for_client(client)&.SexualOrientation),
              HudUtility.last_grade_completed(report_calculator.education_for_client(client)&.LastGradeCompleted),
              HudUtility.no_yes_reasons_for_missing_data(report_calculator.education_for_client(client)&.Employed),
              HudUtility.no_yes_reasons_for_missing_data(report_calculator.enrollment_for_client(client)&.FormerWardChildWelfare),
              HudUtility.no_yes_reasons_for_missing_data(report_calculator.enrollment_for_client(client)&.FormerWardJuvenileJustice),
              HudUtility.no_yes_reasons_for_missing_data(report_calculator.exit_for_client(client)&.ExchangeForSex),
              HudUtility.no_yes_reasons_for_missing_data(report_calculator.exit_for_client(client)&.WorkPlaceViolenceThreats),
              HudUtility.no_yes_reasons_for_missing_data(report_calculator.exit_for_client(client)&.DestinationSafeClient),
