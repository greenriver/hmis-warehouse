    ...
    def self.sub_populations_by_type
      {
        active: {
          ...
          parents: GrdaWarehouse::WarehouseReports::Dashboard::Parents::ActiveClients,
        ...
        entered: {
          ...
          parents: GrdaWarehouse::WarehouseReports::Dashboard::Parents::EnteredClients,
        ...
        housed: {
          ...
          parents: GrdaWarehouse::WarehouseReports::Dashboard::Parents::HousedClients,
