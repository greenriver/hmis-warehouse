...
module GrdaWarehouse::WarehouseReports::Project::DataQuality
  class VersionThree < Base
    ...
    def active_clients
      @active_client ||= service_history_enrollment_scope.
        service_within_date_range(start_date: start, end_date: self.end).
