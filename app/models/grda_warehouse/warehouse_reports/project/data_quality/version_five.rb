...
module GrdaWarehouse::WarehouseReports::Project::DataQuality
  class VersionFive < Base
    include ArelHelper
    include TsqlImport
    include ::Reporting::ProjectDataQualityReports::VersionFive::Display
    include ::Reporting::ProjectDataQualityReports::VersionFive::Support
    ...
    def set_completeness_fields(report_enrollment:, hud_enrollment:, client:, hud_exit:)
      ...
      report_enrollment.set_sex_completeness(sex: client.Sex)
