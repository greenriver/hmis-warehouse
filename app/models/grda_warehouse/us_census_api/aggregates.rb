...
module GrdaWarehouse
  module UsCensusApi
    module Aggregates
      def self.compose(a, b) # rubocop:disable Naming/MethodParameterName
        if a.is_a?(Hash)
          if b.is_a?(Hash)
      ...
      ALL_PEOPLE         = ['POP::TOTAL'].freeze

      #######
      # Age #
      #######

      MALE               = ['POP::MALE'].freeze
      MALE_AGE_0_4       = ['POP::MALE::UNDER_5_YEARS'].freeze
      MALE_AGE_5_9       = ['POP::MALE::5_TO_9_YEARS'].freeze
      MALE_AGE_10_14     = ['POP::MALE::10_TO_14_YEARS'].freeze
      MALE_AGE_15_17     = ['POP::MALE::15_TO_17_YEARS'].freeze
      MALE_AGE_18_24     = ['POP::MALE::18_AND_19_YEARS', 'POP::MALE::20_YEARS', 'POP::MALE::21_YEARS', 'POP::MALE::22_TO_24_YEARS'].freeze
      MALE_AGE_25_34     = ['POP::MALE::25_TO_29_YEARS', 'POP::MALE::30_TO_34_YEARS'].freeze
      MALE_AGE_35_44     = ['POP::MALE::35_TO_39_YEARS', 'POP::MALE::40_TO_44_YEARS'].freeze
      MALE_AGE_45_54     = ['POP::MALE::45_TO_49_YEARS', 'POP::MALE::50_TO_54_YEARS'].freeze
      MALE_AGE_55_64     = ['POP::MALE::55_TO_59_YEARS', 'POP::MALE::60_AND_61_YEARS', 'POP::MALE::62_TO_64_YEARS'].freeze
      MALE_AGE_65_74     = ['POP::MALE::65_AND_66_YEARS', 'POP::MALE::67_TO_69_YEARS', 'POP::MALE::70_TO_74_YEARS'].freeze
      MALE_AGE_75_84     = ['POP::MALE::75_TO_79_YEARS', 'POP::MALE::80_TO_84_YEARS'].freeze
      MALE_AGE_85_PLUS   = ['POP::MALE::85_YEARS_AND_OVER'].freeze

      FEMALE             = ['POP::FEMALE'].freeze
      FEMALE_AGE_0_4     = ['POP::FEMALE::UNDER_5_YEARS'].freeze
      FEMALE_AGE_5_9     = ['POP::FEMALE::5_TO_9_YEARS'].freeze
      FEMALE_AGE_10_14   = ['POP::FEMALE::10_TO_14_YEARS'].freeze
      FEMALE_AGE_15_17   = ['POP::FEMALE::15_TO_17_YEARS'].freeze
      FEMALE_AGE_18_24   = ['POP::FEMALE::18_AND_19_YEARS', 'POP::FEMALE::20_YEARS', 'POP::FEMALE::21_YEARS', 'POP::FEMALE::22_TO_24_YEARS'].freeze
      FEMALE_AGE_25_34   = ['POP::FEMALE::25_TO_29_YEARS', 'POP::FEMALE::30_TO_34_YEARS'].freeze
      FEMALE_AGE_35_44   = ['POP::FEMALE::35_TO_39_YEARS', 'POP::FEMALE::40_TO_44_YEARS'].freeze
      FEMALE_AGE_45_54   = ['POP::FEMALE::45_TO_49_YEARS', 'POP::FEMALE::50_TO_54_YEARS'].freeze
      FEMALE_AGE_55_64   = ['POP::FEMALE::55_TO_59_YEARS', 'POP::FEMALE::60_AND_61_YEARS', 'POP::FEMALE::62_TO_64_YEARS'].freeze
      FEMALE_AGE_65_74   = ['POP::FEMALE::65_AND_66_YEARS', 'POP::FEMALE::67_TO_69_YEARS', 'POP::FEMALE::70_TO_74_YEARS'].freeze
      FEMALE_AGE_75_84   = ['POP::FEMALE::75_TO_79_YEARS', 'POP::FEMALE::80_TO_84_YEARS'].freeze
      FEMALE_AGE_85_PLUS = ['POP::FEMALE::85_YEARS_AND_OVER'].freeze
      ...
      WHITE             = ['POP::WHITE_ALONE'].freeze
      BLACK             = ['POP::BLACK_OR_AFRICAN_AMERICAN_ALONE'].freeze
      NATIVE_AMERICAN   = ['POP::AMERICAN_INDIAN_AND_ALASKA_NATIVE_ALONE'].freeze
      ASIAN             = ['POP::ASIAN_ALONE'].freeze
      PACIFIC_ISLANDER  = ['POP::NATIVE_HAWAIIAN_AND_OTHER_PACIFIC_ISLANDER_ALONE'].freeze
      OTHER_RACE        = ['POP::SOME_OTHER_RACE_ALONE'].freeze
      TWO_OR_MORE_RACES = ['POP::TWO_OR_MORE_RACES'].freeze

      ##############
      ## Hispanic ##
      ##############

      HISPANIC     = ['POP::HISPANIC::TOTAL'].freeze
      NON_HISPANIC = ['POP::NOT_HISPANIC::TOTAL'].freeze
