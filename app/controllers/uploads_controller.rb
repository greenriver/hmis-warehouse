class UploadsController < ApplicationController
  ...
  def create
    ...
    if run_import
      ...
      when 'hmis_611'
        job = Delayed::Job.enqueue Importing::HudZip::SixOneOneJob.new(upload_id: @upload.id, data_source_id: @upload.data_source_id, deidentified: true), queue: :default_priority
      end
