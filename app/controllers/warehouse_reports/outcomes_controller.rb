    ...
    def available_reports
      {
        rrh: {
          ...
          project_types: HudUtilityCurrent.performance_reporting[:rrh],
        },
        psh: {
        ...
        es: {
          ...
          project_types: HudUtilityCurrent.performance_reporting[:es],
        },
        th: {
          class: WarehouseReport::Outcomes::ThReport,
          index_path: warehouse_reports_th_index_path,
          scope: ::Reporting::Housed.th,
          project_types: HudUtilityCurrent.performance_reporting[:th],
        },
      }
    end
