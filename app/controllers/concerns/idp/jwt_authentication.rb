...
#
# Each arm layers its own naming contract (current_user vs current_hmis_user) and failure-response
# format on top of this: the warehouse arm keeps the HTML redirect/render defaults below; the HMIS
# arm overrides idp_handle_unauthenticated / idp_handle_deactivated with JSON responses.
