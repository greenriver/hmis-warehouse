...
module HudReports
  class HistoricPitsController < ApplicationController
    ...
    def related_report
      GrdaWarehouse::WarehouseReports::ReportDefinition.where(url: GrdaWarehouse::WarehouseReports::ReportDefinition.hud_url(:pits))
    end
    ...
    def report_scope
      report_source.active.for_type('Pit')
    end
