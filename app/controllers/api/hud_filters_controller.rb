    ...
    def index
      ...
      respond_to do |format|
        ...
        projects.pluck(
          ...
          project_name += " (#{HudUtilityCurrent.project_type_brief(type)})" if HudUtilityCurrent.project_type_brief(type).present?
          ...
          @data[[o_id, organization_name]] << [project_name, id]
        end
        format.html do
          render layout: false
        end
