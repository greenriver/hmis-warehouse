...
module WarehouseReports
  class RunActiveVeteransJob < BaseJob
    ...
    def perform(params)
      ...
      scope = scope.where(service_history_source.project_type_column => project_types.flat_map { |t| Hud.util.residential_project_type_numbers_by_code[t] }) if project_types.any?
    ...
    def service_history_scope
      project_types = Hud.util.residential_project_type_numbers_by_code.values_at(:es, :th, :so, :sh).flatten.uniq.sort
