...
class TestResultsUploader < CarrierWave::Uploader::Base
  ...
  def content_type_whitelist
    WHITELIST + ['application/vnd.ms-excel', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet']
  end
