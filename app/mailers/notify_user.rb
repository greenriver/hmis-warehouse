class NotifyUser < DatabaseMailer
  ...
  def vispdat_completed vispdat_id
    ...
    users_to_notify.each do |user|
      mail(to: user.email, subject: "#{prefix} A VI-SPDAT was completed.")
    end
  end
  ...
  def client_added client_id
    ...
    users_to_notify.each do |user|
      mail(to: user.email, subject: "#{prefix} A Client was added.")
    end
  end
  ...
  def file_uploaded file_id
    ...
    users_to_notify.each do |user_client|
      ...
      mail(to: user&.email, subject: "#{prefix} A file was uploaded.")
    end
  end
  ...
  def note_added note_id
    ...
    users_to_notify.each do |user_client|
      ...
      mail(to: user&.email, subject: "#{prefix} A note was added.")
    end
  end
  ...
  def anomaly_identified client_id:, user_id:
    ...
    users_to_notify.each do |user|
      mail(to: user.email, subject: "#{prefix} Client anomaly identified")
    end
  end
  ...
  def anomaly_updated client_id:, user_id:, involved_user_ids:
    ...
    users_to_notify = User.where(id: involved_user_ids).
      where.not(id: user_id)
    users_to_notify.each do |user|
      mail(to: user.email, subject: "#{prefix} Client anomaly updated")
    end
  end
  ...
  def chronic_report_finished user_id, report_id
    ...
    mail(to: @user.email, subject: "#{prefix} Your Chronic report has finished")
  end
  ...
  def hud_chronic_report_finished user_id, report_id
    ...
    mail(to: @user.email, subject: "#{prefix} Your HUD Chronic report has finished")
  end
  ...
  def hmis_export_finished user_id, report_id
    ...
    mail(to: @user.email, subject: "#{prefix} Your HMIS Export has finished")
  end
  ...
  def enrolled_disabled_report_finished user_id, report_id
    ...
    mail(to: @user.email, subject: "#{prefix} Your Enrolled with Disability report has finished")
  end
  ...
  def active_veterans_report_finished user_id, report_id
    ...
    mail(to: @user.email, subject: "#{prefix} Your Active Veterans report has finished")
  end
