...
CREATE TABLE public.reports (
    ...
    number_files_expected integer DEFAULT 0,
    report_data_removed boolean DEFAULT false,
    stored_to_s3 boolean DEFAULT false,
    data_cleaned boolean DEFAULT false,
    archived_successfully boolean DEFAULT false
);
...
--
-- Name: index_report_files_on_filename; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_report_files_on_filename ON public.report_files USING btree (filename);


--
-- Name: index_report_files_on_report; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_report_files_on_report ON public.report_files USING btree (report_type, report_id);


--
-- Name: index_report_files_on_report_type_and_report_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_report_files_on_report_type_and_report_id ON public.report_files USING btree (report_type, report_id);
