class AddHmisActivityLog < ActiveRecord::Migration[6.1]
  def change
    create_table :hmis_activity_logs do |t|
      ...
      t.references :header_client, comment: 'user-provided', index: false
      t.references :header_enrollment, comment: 'user-provided', index: false
      t.references :header_project, comment: 'user-provided', index: false
