class WarehouseClientPhotoPermissionDataMigration < ActiveRecord::Migration[7.0]
  # data migration only
  disable_ddl_transaction!

  # preserve current ability to see client photo for roles that can search/view clients
  def up
    view_cond = <<~SQL
    ...
    Role.where(view_cond).
      ...
      update_all(can_view_client_photo: true)
