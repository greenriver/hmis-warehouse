...
ActiveRecord::Schema.define(version: 2020_07_01_192839) do
  ...
  create_view "bi_Demographics", sql_definition: <<-SQL
      ...
      "Client".housing_assistance_network_released_on,
      "Client".sync_with_cas,
      "Client".dmh_eligible,
      "Client".va_eligible,
      "Client".hues_eligible,
      "Client".hiv_positive,
      "Client".housing_release_status,
      "Client".chronically_homeless_for_cas,
      "Client".us_citizen,
      "Client".asylee,
      "Client".ineligible_immigrant,
      "Client".lifetime_sex_offender,
      "Client".meth_production_conviction,
      "Client".family_member,
      "Client".child_in_household,
      "Client".ha_eligible,
      "Client".api_update_in_process,
      "Client".api_update_started_at,
      "Client".api_last_updated_at,
      "Client".creator_id,
      "Client".cspech_eligible,
      "Client".consent_form_signed_on,
      "Client".vispdat_prioritization_days_homeless,
      "Client".generate_history_pdf,
      "Client".congregate_housing,
      "Client".sober_housing,
      "Client".consent_form_id,
      "Client".rrh_assessment_score,
      "Client".ssvf_eligible,
      "Client".rrh_desired,
      "Client".youth_rrh_desired,
      "Client".rrh_assessment_contact_info,
      "Client".rrh_assessment_collected_at,
      "Client".source_hash,
      "Client".generate_manual_history_pdf,
      ...
      "Client".neighborhood_interests,
      "Client".verified_veteran_status,
      "Client".interested_in_set_asides,
      "Client".consent_expires_on,
      "Client".pending_date_deleted,
      "Client".cas_match_override,
      "Client".vash_eligible,
      "Client".consented_coc_codes,
      "Client".income_maximization_assistance_requested,
      "Client".income_total_monthly,
      "Client".pending_subsidized_housing_placement,
      "Client".pathways_domestic_violence,
      "Client".rrh_th_desired,
      "Client".sro_ok,
      "Client".pathways_other_accessibility,
      "Client".pathways_disabled_housing,
      "Client".evicted,
      "Client".dv_rrh_desired,
