...
--
-- Name: index_project_scorecard_reports_on_spm_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_project_scorecard_reports_on_spm_id ON public.project_scorecard_reports USING btree (spm_id);
