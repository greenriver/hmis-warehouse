...
class CreateHmisProjectCollectionMembers < ActiveRecord::Migration[7.1]
  def change
    ...
    create_view view
    create_trigger(:attempt_hmis_project_access_group_members_del, on: view, sql_definition: <<~SQL)
    ...
    SQL
    create_trigger(:attempt_hmis_project_access_group_members_up, on: view, sql_definition: <<~SQL)
...
# rails db:migrate:up:warehouse VERSION=20250617234921
