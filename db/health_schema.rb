...
ActiveRecord::Schema[7.0].define(version: 2024_08_07_185011) do
  ...
  create_table "any_careplans", force: :cascade do |t|
    t.bigint "patient_id"
    ...
    t.index ["instrument_type", "instrument_id"], name: "index_any_careplans_on_instrument"
  ...
  create_table "appointments", force: :cascade do |t|
    ...
    t.index ["department"], name: "index_appointments_on_department"
  end
  ...
  create_table "ca_assessments", force: :cascade do |t|
    t.bigint "patient_id"
    t.string "instrument_type"
    t.bigint "instrument_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.datetime "deleted_at", precision: nil
    t.index ["instrument_type", "instrument_id"], name: "index_ca_assessments_on_instrument"
  ...
  create_table "careplans", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
    t.datetime "patient_signed_on", precision: nil
    t.datetime "provider_signed_on", precision: nil
    ...
    t.datetime "responsible_team_member_signed_on", precision: nil
    t.datetime "representative_signed_on", precision: nil
    t.text "service_archive"
    t.text "equipment_archive"
    t.text "team_members_archive"
    t.text "goals_archive"
    t.datetime "patient_signature_requested_at", precision: nil
    t.datetime "provider_signature_requested_at", precision: nil
    ...
    t.boolean "rn_approval"
    t.bigint "approving_rn_id"
    t.date "rn_approved_on"
    t.boolean "ncm_approval"
    t.bigint "approving_ncm_id"
    t.date "ncm_approved_on"
    t.boolean "careplan_sent"
    t.bigint "careplan_sender_id"
    t.date "careplan_sent_on"
    t.index ["approving_ncm_id"], name: "index_careplans_on_approving_ncm_id"
    t.index ["approving_rn_id"], name: "index_careplans_on_approving_rn_id"
    t.index ["careplan_sender_id"], name: "index_careplans_on_careplan_sender_id"
  ...
  create_table "claims", force: :cascade do |t|
    ...
    t.datetime "precalculated_at", precision: nil
    t.string "result"
  ...
  create_table "claims_reporting_medical_claims", force: :cascade do |t|
    ...
    t.string "cde_ndc", limit: 48
    t.string "pcc_repricing_fee_flag", limit: 50
    t.string "cde_enc_rec_ind", limit: 50
    ...
    t.index ["member_id", "procedure_code"], name: "med_claim_member_procedure_index"
  ...
  create_table "contacts", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.index ["patient_id", "source_id", "source_type"], name: "index_contacts_on_patient_id_and_source_id_and_source_type", unique: true
    t.index ["patient_id"], name: "index_contacts_on_patient_id"
    t.index ["source_type", "source_id"], name: "index_contacts_on_source_type_and_source_id"
  end

  create_table "coordination_teams", force: :cascade do |t|
    t.string "name"
    t.string "color"
    t.bigint "team_coordinator_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "team_nurse_care_manager_id"
    t.index ["team_coordinator_id"], name: "index_coordination_teams_on_team_coordinator_id"
  ...
  create_table "ed_ip_visits", force: :cascade do |t|
    t.bigint "loaded_ed_ip_visit_id"
    t.string "medicaid_id"
    t.date "admit_date"
    t.string "encounter_major_class"
    t.datetime "deleted_at", precision: nil
    t.string "encounter_id"
    t.index ["encounter_id"], name: "index_ed_ip_visits_on_encounter_id", unique: true
    t.index ["loaded_ed_ip_visit_id"], name: "index_ed_ip_visits_on_loaded_ed_ip_visit_id"
  ...
  create_table "epic_careplans", force: :cascade do |t|
    ...
    t.string "encounter_id"
    t.string "encounter_type"
    t.datetime "careplan_updated_at", precision: nil
    t.string "staff"
    t.text "part_1"
    t.text "part_2"
    t.text "part_3"
  ...
  create_table "epic_chas", force: :cascade do |t|
    ...
    t.string "encounter_id"
    t.string "encounter_type"
    t.datetime "cha_updated_at", precision: nil
    t.string "staff"
  ...
  create_table "epic_goals", force: :cascade do |t|
    ...
    t.datetime "goal_created_at", precision: nil
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.integer "data_source_id", default: 6, null: false
  end
  ...
  create_table "epic_patients", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: nil, null: false
    t.string "gender"
    t.datetime "consent_revoked", precision: nil
    t.string "medicaid_id"
    t.string "housing_status"
    t.datetime "housing_status_timestamp", precision: nil
    t.boolean "pilot", default: false, null: false
    t.integer "data_source_id", default: 6, null: false
    t.datetime "deleted_at", precision: nil
    t.date "death_date"
    t.index ["deleted_at"], name: "index_epic_patients_on_deleted_at"
    t.index ["id_in_source"], name: "index_epic_patients_on_id_in_source"
  ...
  create_table "epic_ssms", force: :cascade do |t|
    ...
    t.string "encounter_id"
    t.string "encounter_type"
    t.datetime "ssm_updated_at", precision: nil
    t.string "staff"
    t.text "part_1"
    t.text "part_2"
    t.text "part_3"
  ...
  create_table "epic_team_members", force: :cascade do |t|
    ...
    t.string "email"
    t.string "phone"
    t.datetime "processed", precision: nil
    t.integer "data_source_id", null: false
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  end

  create_table "epic_thrives", force: :cascade do |t|
    t.string "patient_id"
    t.string "id_in_source"
    t.datetime "thrive_updated_at", precision: nil
    t.string "housing_status"
    ...
    t.datetime "updated_at", null: false
    t.string "reporter"
    t.integer "positive_food_security_count"
    t.integer "positive_housing_questions_count"
    t.string "staff"
  end
  ...
  create_table "hca_assessments", force: :cascade do |t|
    ...
    t.jsonb "funders"
    t.string "pcp_provider"
    t.string "pcp_address"
    t.string "pcp_phone"
    t.string "pcp_notes"
    t.string "hh_provider"
    t.string "hh_address"
    t.string "hh_phone"
    t.string "hh_notes"
    t.string "psych_provider"
    t.string "psych_address"
    t.string "psych_phone"
    t.string "psych_notes"
    t.string "therapist_provider"
    t.string "therapist_address"
    t.string "therapist_phone"
    t.string "therapist_notes"
    t.string "case_manager_provider"
    t.string "case_manager_address"
    t.string "case_manager_phone"
    t.string "case_manager_notes"
    t.string "specialist_provider"
    t.string "specialist_address"
    t.string "specialist_phone"
    t.string "specialist_notes"
    t.string "guardian_provider"
    t.string "guardian_address"
    t.string "guardian_phone"
    t.string "guardian_notes"
    t.string "rep_payee_provider"
    t.string "rep_payee_address"
    t.string "rep_payee_phone"
    t.string "rep_payee_notes"
    t.string "social_support_provider"
    t.string "social_support_address"
    t.string "social_support_phone"
    t.string "social_support_notes"
    t.string "cbfs_provider"
    t.string "cbfs_address"
    t.string "cbfs_phone"
    t.string "cbfs_notes"
    t.string "housing_provider"
    t.string "housing_address"
    t.string "housing_phone"
    t.string "housing_notes"
    t.string "day_provider"
    t.string "day_address"
    t.string "day_phone"
    t.string "day_notes"
    t.string "job_provider"
    t.string "job_address"
    t.string "job_phone"
    t.string "job_notes"
    t.string "peer_support_provider"
    t.string "peer_support_address"
    t.string "peer_support_phone"
    t.string "peer_support_notes"
    t.string "dta_provider"
    t.string "dta_address"
    t.string "dta_phone"
    t.string "dta_notes"
    t.string "va_provider"
    t.string "va_address"
    t.string "va_phone"
    t.string "va_notes"
    t.string "probation_provider"
    t.string "probation_address"
    t.string "probation_phone"
    t.string "probation_notes"
    t.string "other_provider_provider"
    t.string "other_provider_address"
    t.string "other_provider_phone"
    t.string "other_provider_notes"
    t.string "hip_fracture_status"
    t.string "hip_fracture_notes"
    t.string "other_fracture_status"
    t.string "other_fracture_notes"
    t.string "chronic_pain_status"
    t.string "chronic_pain_notes"
    t.string "alzheimers_status"
    t.string "alzheimers_notes"
    t.string "dementia_status"
    t.string "dementia_notes"
    t.string "stroke_status"
    t.string "stroke_notes"
    t.string "parkinsons_status"
    t.string "parkinsons_notes"
    t.string "hypertension_status"
    t.string "hypertension_notes"
    t.string "cad_status"
    t.string "cad_notes"
    t.string "chf_status"
    t.string "chf_notes"
    t.string "copd_status"
    t.string "copd_notes"
    t.string "asthma_status"
    t.string "asthma_notes"
    t.string "apnea_status"
    t.string "apnea_notes"
    t.string "anxiety_status"
    t.string "anxiety_notes"
    t.string "bipolar_status"
    t.string "bipolar_notes"
    t.string "depression_status"
    t.string "depression_notes"
    t.string "schizophrenia_status"
    t.string "schizophrenia_notes"
    t.string "cancer_status"
    t.string "cancer_notes"
    t.string "diabetes_status"
    t.string "diabetes_notes"
    t.string "arthritis_status"
    t.string "arthritis_notes"
    t.string "ckd_status"
    t.string "ckd_notes"
    t.string "liver_status"
    t.string "liver_notes"
    t.string "transplant_status"
    t.string "transplant_notes"
    t.string "weight_status"
    t.string "weight_notes"
    t.string "other_condition_status"
    t.string "other_condition_notes"
    ...
    t.string "care_goals"
    t.string "address"
    t.string "legal_comments"
    t.index ["patient_id"], name: "index_hca_assessments_on_patient_id"
    t.index ["user_id"], name: "index_hca_assessments_on_user_id"
  end

  create_table "hca_medications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["assessment_id"], name: "index_hca_medications_on_assessment_id"
  end

  create_table "hca_sud_treatments", force: :cascade do |t|
    t.bigint "assessment_id"
  ...
  create_table "health_flexible_service_follow_ups", force: :cascade do |t|
    ...
    t.index ["vpr_id"], name: "index_health_flexible_service_follow_ups_on_vpr_id"
  end
  ...
  create_table "health_flexible_service_vprs", force: :cascade do |t|
    ...
    t.datetime "deleted_at", precision: nil
    t.date "end_date"
    t.string "primary_language_detail"
    t.boolean "open", default: true
    t.bigint "client_id"
    t.string "medicaid_id"
    t.bigint "aco_id"
    t.index ["aco_id"], name: "index_health_flexible_service_vprs_on_aco_id"
    t.index ["client_id"], name: "index_health_flexible_service_vprs_on_client_id"
  ...
  create_table "health_qa_factory_factories", force: :cascade do |t|
    t.bigint "patient_id"
    t.bigint "careplan_id"
    t.bigint "hrsn_screening_qa_id"
    t.bigint "ca_development_qa_id"
    t.bigint "ca_completed_qa_id"
    t.bigint "careplan_development_qa_id"
    t.bigint "careplan_completed_qa_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ca_completed_qa_id"], name: "index_health_qa_factory_factories_on_ca_completed_qa_id"
    t.index ["ca_development_qa_id"], name: "index_health_qa_factory_factories_on_ca_development_qa_id"
    t.index ["careplan_completed_qa_id"], name: "index_health_qa_factory_factories_on_careplan_completed_qa_id"
    t.index ["careplan_development_qa_id"], name: "index_health_qa_factory_factories_on_careplan_development_qa_id"
    t.index ["careplan_id"], name: "index_health_qa_factory_factories_on_careplan_id"
    t.index ["hrsn_screening_qa_id"], name: "index_health_qa_factory_factories_on_hrsn_screening_qa_id"
    t.index ["patient_id"], name: "index_health_qa_factory_factories_on_patient_id"
  end
  ...
  create_table "hl7_value_set_codes", force: :cascade do |t|
    ...
    t.index ["value_set_oid", "code_system", "code"], name: "hl_value_set_code_uniq_by_code_system_code", unique: true
  ...
  create_table "housing_statuses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["patient_id"], name: "index_housing_statuses_on_patient_id"
  end

  create_table "hrsn_screenings", force: :cascade do |t|
    t.bigint "patient_id"
    t.string "instrument_type"
    t.bigint "instrument_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.datetime "deleted_at", precision: nil
    t.index ["instrument_type", "instrument_id"], name: "index_hrsn_screenings_on_instrument"
    t.index ["patient_id"], name: "index_hrsn_screenings_on_patient_id"
  end
  ...
  create_table "loaded_ed_ip_visits", force: :cascade do |t|
    ...
    t.string "encounter_id"
    t.index ["created_at"], name: "index_loaded_ed_ip_visits_on_created_at"
    t.index ["deleted_at"], name: "index_loaded_ed_ip_visits_on_deleted_at"
    t.index ["ed_ip_visit_file_id"], name: "index_loaded_ed_ip_visits_on_ed_ip_visit_file_id"
    t.index ["medicaid_id"], name: "index_loaded_ed_ip_visits_on_medicaid_id"
  ...
  create_table "member_status_reports", force: :cascade do |t|
    ...
    t.datetime "sent_export_time_stamp", precision: nil
    t.string "receiver"
  ...
  create_table "mhx_external_ids", force: :cascade do |t|
    t.bigint "client_id", null: false
    t.string "identifier", null: false
    t.datetime "invalidated_at", precision: nil
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["client_id"], name: "index_mhx_external_ids_on_client_id"
    t.index ["identifier"], name: "index_mhx_external_ids_on_identifier"
  end

  create_table "mhx_medicaid_id_inquiries", force: :cascade do |t|
    t.date "service_date", null: false
    t.string "inquiry"
    t.string "result"
    t.integer "isa_control_number", null: false
  ...
  create_table "mhx_medicaid_id_responses", force: :cascade do |t|
    t.bigint "medicaid_id_inquiry_id"
    t.string "response"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["medicaid_id_inquiry_id"], name: "index_mhx_medicaid_id_responses_on_medicaid_id_inquiry_id"
  end

  create_table "mhx_response_external_ids", force: :cascade do |t|
    t.bigint "response_id"
    t.bigint "external_id_id"
    t.index ["external_id_id"], name: "index_mhx_response_external_ids_on_external_id_id"
    t.index ["response_id"], name: "index_mhx_response_external_ids_on_response_id"
  end

  create_table "mhx_responses", force: :cascade do |t|
    t.bigint "submission_id"
    t.string "error_report"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["submission_id"], name: "index_mhx_responses_on_submission_id"
  end

  create_table "mhx_submission_external_ids", force: :cascade do |t|
    t.bigint "submission_id"
    t.bigint "external_id_id"
    t.index ["external_id_id"], name: "index_mhx_submission_external_ids_on_external_id_id"
    t.index ["submission_id"], name: "index_mhx_submission_external_ids_on_submission_id"
  end

  create_table "mhx_submissions", force: :cascade do |t|
  ...
  create_table "participation_forms", force: :cascade do |t|
    ...
    t.datetime "reviewed_at", precision: nil
    t.string "reviewer"
    t.boolean "verbal_approval", default: false
  ...
  create_table "patients", force: :cascade do |t|
    ...
    t.index ["housing_navigator_id"], name: "index_patients_on_housing_navigator_id"
  ...
  create_table "pctp_care_goals", force: :cascade do |t|
    t.bigint "careplan_id"
    t.string "domain"
    t.string "goal"
    t.string "status"
    ...
    t.datetime "updated_at", null: false
    t.datetime "deleted_at", precision: nil
    t.index ["careplan_id"], name: "index_pctp_care_goals_on_careplan_id"
  end

  create_table "pctp_careplans", force: :cascade do |t|
    t.bigint "patient_id", null: false
    t.bigint "user_id", null: false
    t.string "name"
    t.date "dob"
    ...
    t.string "rn_phone"
    t.string "rn_email"
    t.string "other_members_name"
    t.string "other_members_phone"
    t.string "other_members_email"
    t.string "overview"
    t.string "scribe"
    t.string "update_reason"
    t.string "update_reason_other"
    ...
    t.string "social_support_name"
    t.string "social_support_phone"
    t.string "social_support_email"
    t.string "name_sent_to"
    t.index ["patient_id"], name: "index_pctp_careplans_on_patient_id"
    t.index ["user_id"], name: "index_pctp_careplans_on_user_id"
  end

  create_table "pctp_needs", force: :cascade do |t|
    t.bigint "careplan_id"
    t.string "domain"
  ...
  create_table "qualifying_activities", force: :cascade do |t|
    ...
    t.string "source_type"
    t.integer "source_id"
    t.datetime "claim_submitted_on", precision: nil
    t.date "date_of_activity"
    t.integer "user_id"
    ...
    t.string "valid_unpayable_reasons", array: true
    t.date "deleted_at"
    t.string "claim_metadata_type"
    t.bigint "claim_metadata_id"
    t.index ["claim_id"], name: "index_qualifying_activities_on_claim_id"
    t.index ["claim_metadata_type", "claim_metadata_id"], name: "index_qualifying_activities_on_claim_metadata"
  ...
  create_table "release_forms", force: :cascade do |t|
    ...
    t.string "reviewer"
    t.boolean "verbal_approval", default: false
    t.date "participation_signature_on"
    t.string "mode_of_contact"
  ...
  create_table "scheduled_documents", force: :cascade do |t|
    t.string "type"
    t.string "name"
    t.string "protocol"
    t.string "hostname"
    ...
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.integer "acos", default: [], array: true
  ...
  create_table "sdh_case_management_notes", force: :cascade do |t|
    ...
    t.datetime "date_of_contact", precision: nil
    t.string "place_of_contact"
    t.string "housing_status"
    t.string "place_of_contact_other"
    t.string "housing_status_other"
    t.datetime "housing_placement_date", precision: nil
  ...
  create_table "signable_documents", force: :cascade do |t|
    ...
    t.datetime "hs_initial_response_at", precision: nil
    t.jsonb "hs_last_response"
    t.datetime "hs_last_response_at", precision: nil
  ...
  create_table "thrive_assessments", force: :cascade do |t|
    ...
    t.index ["patient_id"], name: "index_thrive_assessments_on_patient_id"
    t.index ["user_id"], name: "index_thrive_assessments_on_user_id"
  end
  ...
  create_table "tracing_cases", force: :cascade do |t|
    ...
    t.string "vaccinated"
    t.jsonb "vaccine"
    t.jsonb "vaccination_dates"
    t.string "vaccination_complete"
  ...
  create_table "user_care_coordinators", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: nil, null: false
    t.datetime "deleted_at", precision: nil
    t.bigint "coordination_team_id"
    t.index ["coordination_team_id"], name: "index_user_care_coordinators_on_coordination_team_id"
  end
  ...
  create_table "vaccinations", force: :cascade do |t|
    ...
    t.datetime "epic_row_created", precision: nil
    t.datetime "epic_row_updated", precision: nil
  ...
  create_table "visits", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: nil, null: false
    t.string "patient_id"
    t.datetime "date_of_service", precision: nil
    t.integer "data_source_id", default: 6, null: false
  end
