...
ActiveRecord::Schema.define(version: 20191029172244) do
  ...
  create_table "activity_logs", force: :cascade do |t|
    ...
    t.index ["controller_name"], name: "index_activity_logs_on_controller_name", using: :btree
    t.index ["created_at", "item_model", "user_id"], name: "index_activity_logs_on_created_at_and_item_model_and_user_id", using: :btree
    t.index ["created_at"], name: "activity_logs_created_at_idx", using: :brin
    t.index ["created_at"], name: "created_at_idx", using: :brin
    t.index ["item_model", "user_id", "created_at"], name: "index_activity_logs_on_item_model_and_user_id_and_created_at", using: :btree
    t.index ["item_model", "user_id"], name: "index_activity_logs_on_item_model_and_user_id", using: :btree
    t.index ["item_model"], name: "index_activity_logs_on_item_model", using: :btree
    t.index ["user_id", "item_model", "created_at"], name: "index_activity_logs_on_user_id_and_item_model_and_created_at", using: :btree
  ...
  create_table "clients_unduplicated", force: :cascade do |t|
    ...
    t.integer "dc_id"
    t.index ["unduplicated_client_id"], name: "unduplicated_clients_unduplicated_client_id", using: :btree
  end
  ...
  create_table "glacier_archives", force: :cascade do |t|
    ...
    t.index ["glacier_vault_id"], name: "index_glacier_archives_on_glacier_vault_id", using: :btree
    t.index ["upload_id"], name: "index_glacier_archives_on_upload_id", unique: true, using: :btree
  end
  ...
  create_table "glacier_vaults", force: :cascade do |t|
    ...
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
    t.index ["name"], name: "index_glacier_vaults_on_name", unique: true, using: :btree
  end
  ...
  create_table "imports", force: :cascade do |t|
    ...
    t.index ["deleted_at"], name: "index_imports_on_deleted_at", using: :btree
  end
  ...
  create_table "report_results", force: :cascade do |t|
    ...
    t.integer  "file_id"
    t.index ["deleted_at"], name: "index_report_results_on_deleted_at", using: :btree
  ...
  create_table "reports", force: :cascade do |t|
    ...
    t.index ["report_results_summary_id"], name: "index_reports_on_report_results_summary_id", using: :btree
  end
  ...
  create_table "similarity_metrics", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["type"], name: "index_similarity_metrics_on_type", unique: true, using: :btree
  end
  ...
  create_table "tokens", force: :cascade do |t|
    ...
    t.index ["updated_at"], name: "index_tokens_on_updated_at", using: :btree
  end
