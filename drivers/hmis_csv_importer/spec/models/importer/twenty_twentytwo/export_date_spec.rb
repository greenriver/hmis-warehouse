  ...
  describe 'initial load' do
    before(:all) do
      ...
      import_hmis_csv_fixture(
        'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twentytwo/export_date_fixtures/date_updated_initial',
        version: 'AutoMigrate',
    ...
    describe 'older update' do
      before(:all) do
        import_hmis_csv_fixture(
          'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twentytwo/export_date_fixtures/date_updated_older',
          version: 'AutoMigrate',
          data_source: @data_source,
          run_jobs: false,
        )
    ...
    describe 'same day update' do
      before(:all) do
        import_hmis_csv_fixture(
          'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twentytwo/export_date_fixtures/date_updated_same_day',
          version: 'AutoMigrate',
          data_source: @data_source,
          run_jobs: false,
        )
    ...
    describe 'newer update' do
      before(:all) do
        import_hmis_csv_fixture(
          'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twentytwo/export_date_fixtures/date_updated_newer',
          version: 'AutoMigrate',
          data_source: @data_source,
          run_jobs: false,
        )
