...
RSpec.describe HmisCsvImporter, type: :model do
  describe 'When handling source files' do
    ...
    it 'can import files with bom|UTF-8 encoding' do
      file_path = 'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twenty/bom_test'
    ...
    it 'can import files with bad line endings' do
      ...
      file_path = 'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twenty/bad_ending'
      import_hmis_csv_fixture(file_path, version: 'AutoMigrate', run_jobs: false)
  ...
  describe 'When importing enrollments' do
    before(:all) do
      ...
      import_hmis_csv_fixture(
        'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twenty/enrollment_test_files',
        version: 'AutoMigrate',
        run_jobs: true,
      )
    end
    ...
    describe 'when importing updated enrollment data' do
      before(:all) do
        import_hmis_csv_fixture(
          'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twenty/enrollment_change_files',
          version: 'AutoMigrate',
          run_jobs: false,
        )
      end
  ...
  describe 'When importing enrollments with deletes' do
    before(:all) do
      ...
      GrdaWarehouse::Utility.clear!
      import_hmis_csv_fixture(
        'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twenty/enrollment_with_deletes_test_files',
        version: 'AutoMigrate',
        run_jobs: false,
      )
    end
  ...
  describe 'When importing projects' do
    before(:all) do
      ...
      GrdaWarehouse::Utility.clear!
      import_hmis_csv_fixture(
        'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twenty/project_test_files',
        version: 'AutoMigrate',
        run_jobs: false,
      )
    end
  ...
  describe 'When importing enrollments and clients with restores' do
    before(:all) do
      ...
      import_hmis_csv_fixture(
        'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twenty/enrollment_test_with_restores_initial_files',
        version: 'AutoMigrate',
        run_jobs: false,
      )
    end
    ...
    describe 'after second import' do
      before(:all) do
        import_hmis_csv_fixture(
          'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twenty/enrollment_test_with_restores_update_files',
          version: 'AutoMigrate',
          run_jobs: false,
        )
      end
