  ...
  describe 'initial load' do
    before(:all) do
      ...
      import_hmis_csv_fixture(
        'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twenty/date_updated_initial',
    ...
    describe 'older update' do
      before(:all) do
        import_hmis_csv_fixture(
          'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twenty/date_updated_older',
          data_source: @data_source,
          version: 'AutoMigrate',
          run_jobs: false,
        )
    ...
    describe 'same day update' do
      before(:all) do
        import_hmis_csv_fixture(
          'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twenty/date_updated_same_day',
          data_source: @data_source,
          version: 'AutoMigrate',
          run_jobs: false,
        )
    ...
    describe 'newer update' do
      before(:all) do
        import_hmis_csv_fixture(
          'drivers/hmis_csv_importer/spec/fixtures/files/twenty_twenty/date_updated_newer',
          data_source: @data_source,
          version: 'AutoMigrate',
          run_jobs: false,
        )
