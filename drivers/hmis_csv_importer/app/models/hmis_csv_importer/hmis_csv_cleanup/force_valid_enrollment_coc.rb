  ...
  class ForceValidEnrollmentCoc < Base
    def cleanup!
      ...
      enrollment_scope.find_each do |enrollment|
        ...
        next if ::Hud.util.valid_coc?(enrollment.EnrollmentCoC)
        ...
        enrollment.EnrollmentCoC = nil if enrollment.EnrollmentCoC.present? && ! ::Hud.util.valid_coc?(enrollment.EnrollmentCoC)
