  ...
  class ForceValidEnrollmentCoc < Base
    def cleanup!
      ...
      enrollment_scope.find_each do |enrollment|
        ...
        next if ::HudUtilityCurrent.valid_coc?(enrollment.EnrollmentCoC)
        ...
        enrollment.EnrollmentCoC = nil if enrollment.EnrollmentCoC.present? && ! ::HudUtilityCurrent.valid_coc?(enrollment.EnrollmentCoC)
