...
module HmisCsvImporter::Aggregated
  class Enrollment < GrdaWarehouse::Hud::Base
    ...
    has_one :exit, primary_key: [:EnrollmentID, :PersonalID, :data_source_id], query_constraints: [:EnrollmentID, :PersonalID, :data_source_id], class_name: 'HmisCsvImporter::Aggregated::Exit', autosave: false
    belongs_to :project, primary_key: [:ProjectID, :data_source_id], query_constraints: [:ProjectID, :data_source_id], class_name: 'HmisCsvImporter::Importer::Project', autosave: false, optional: true
