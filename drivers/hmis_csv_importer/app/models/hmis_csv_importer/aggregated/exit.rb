...
module HmisCsvImporter::Aggregated
  class Exit < GrdaWarehouse::Hud::Base
    ...
    belongs_to :enrollment, primary_key: [:EnrollmentID, :PersonalID, :data_source_id], query_constraints: [:EnrollmentID, :PersonalID, :data_source_id], class_name: 'HmisCsvImporter::Aggregated::Enrollment', autosave: false, optional: true
