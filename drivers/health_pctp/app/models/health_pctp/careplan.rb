  ...
  class Careplan < HealthBase
    ...
    def care_team_members
      {
        ...
        ccm: "Enrollee's Team Coordinator/Clinical Care Manager(s)",
    ...
    def contingency_plan_default
      "Client is encouraged to develop a contingency plan with natural supports to address critical needs that they are not able to manage on their own.\n" +
        ...
        "Client can contact JYP Clinic (857-654-1605) to schedule medical appointment or present to clinic for open access appointment during clinic business hours.\n" +
    ...
    def crisis_plan_default
      "For Psychiatric emergency, If the risk is imminent call 911.\n" +
