  ...
  module GrdaWarehouse
    module HmisFormExtension
      ...
      def current_school_attendance
        ...
        return HudHelper.util.current_school_attended(hud_answer, true) if hud_answer.present?
      ...
      def most_recent_educational_status
        ...
        return HudHelper.util.most_recent_ed_status(hud_answer, true) if hud_answer.present?
