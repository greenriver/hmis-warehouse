    ...
    def self.detail_headers
      {
        ...
        current_living_situation: { title: 'Current Living Situation', translator: ->(v) { "#{HudUtilityCurrent.living_situation(v)} (#{v})" } },
    ...
    def self.sections(_)
      {
        current_living_situation_issues: {
          ...
          limiter: ->(item) {
            ! HudUtilityCurrent.valid_current_living_situations.include?(item.situation)
          },
        },
      }.freeze
    end
