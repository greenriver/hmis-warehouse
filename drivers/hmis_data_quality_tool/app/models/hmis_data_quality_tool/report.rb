    ...
    private def result_groups
      {
        'Clients' => {
          ...
          afghanistan_oef: Client,
          iraq_oif: Client,
          iraq_ond: Client,
          military_branch: Client,
          discharge_status: Client,
          employed: Client,
          employment_type_matches_status: Client,
          not_employed_reason_matches_status: Client,
        },
        'Enrollments' => {
        ...
        'Services' => {
          ...
          entering_from_streets_issues: Enrollment,
        },
        'Inventory' => {
