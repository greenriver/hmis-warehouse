    ...
    def self.detail_headers
      {
        ...
        name_data_quality: { title: 'Name Data Quality', translator: ->(v) { "#{Hud.util.name_data_quality(v)} (#{v})" } },
        personal_id: { title: 'HMIS Personal ID' },
        dob: { title: 'DOB' },
        dob_data_quality: { title: 'DOB Data Quality', translator: ->(v) { "#{Hud.util.dob_data_quality(v)} (#{v})" } },
        man: { title: 'Man', translator: ->(v) { "#{Hud.util.no_yes(v)} (#{v})" } },
        woman: { title: 'Woman', translator: ->(v) { "#{Hud.util.no_yes(v)} (#{v})" } },
        culturally_specific: { title: 'Culturally Specific', translator: ->(v) { "#{Hud.util.no_yes(v)} (#{v})" } },
        different_identity: { title: 'DifferentIdentity', translator: ->(v) { "#{Hud.util.no_yes(v)} (#{v})" } },
        non_binary: { title: 'Non-Binary', translator: ->(v) { "#{Hud.util.no_yes(v)} (#{v})" } },
        transgender: { title: 'Transgender', translator: ->(v) { "#{Hud.util.no_yes(v)} (#{v})" } },
        questioning: { title: 'Questioning', translator: ->(v) { "#{Hud.util.no_yes(v)} (#{v})" } },
        gender_none: { title: 'Gender None', translator: ->(v) { "#{Hud.util.gender_none(v)} (#{v})" } },
        am_ind_ak_native: { title: 'American Indian, Alaska Native, or Indigenous', translator: ->(v) { "#{Hud.util.no_yes(v&.to_i)} (#{v})" } },
        asian: { title: 'Asian or Asian American', translator: ->(v) { "#{Hud.util.no_yes(v&.to_i)} (#{v})" } },
        black_af_american: { title: 'Black, African American, or African', translator: ->(v) { "#{Hud.util.no_yes(v&.to_i)} (#{v})" } },
        native_hi_pacific: { title: 'Native Hawaiian or Pacific Islander', translator: ->(v) { "#{Hud.util.no_yes(v&.to_i)} (#{v})" } },
        white: { title: 'White', translator: ->(v) { "#{Hud.util.no_yes(v&.to_i)} (#{v})" } },
        mid_east_n_african: { title: 'Middle Eastern or North African', translator: ->(v) { "#{Hud.util.no_yes(v&.to_i)} (#{v})" } },
        hispanic_latinaeo: { title: 'Hispanic/Latina/e/o', translator: ->(v) { "#{Hud.util.no_yes(v&.to_i)} (#{v})" } },
        race_none: { title: 'Race None', translator: ->(v) { "#{Hud.util.race_none(v)} (#{v})" } },
        veteran_status: { title: 'Veteran Status', translator: ->(v) { "#{Hud.util.no_yes_reasons_for_missing_data(v)} (#{v})" } },
        ssn: { title: 'SSN', translator: ->(v) { masked_ssn(v) } },
        ssn_data_quality: { title: 'SSN Data Quality', translator: ->(v) { "#{Hud.util.ssn_data_quality(v)} (#{v})" } },
    ...
    def self.sections(_)
      {
        gender_issues: {
          ...
          limiter: ->(item) {
            ...
            return true if (values - Hud.util.no_yes_options.keys).any?
