...
module HmisDataQualityTool
  class Enrollment < ::HudReports::ReportClientBase
    ...
    def self.detail_headers
      {
        ...
        domestic_violence_victim_at_entry: { title: 'Survivor of domestic violence response at entry', translator: ->(v) { "#{HudHelper.util.no_yes_reasons_for_missing_data(v)} (#{v})" } },
        income_from_any_source_at_entry: { title: 'Income from any source at entry', translator: ->(v) { "#{HudHelper.util.no_yes_reasons_for_missing_data(v)} (#{v})" } },
        income_from_any_source_at_annual: { title: 'Income from any source at annual assessment', translator: ->(v) { "#{HudHelper.util.no_yes_reasons_for_missing_data(v)} (#{v})" } },
        income_from_any_source_at_exit: { title: 'Income from any source at exit', translator: ->(v) { "#{HudHelper.util.no_yes_reasons_for_missing_data(v)} (#{v})" } },
        ...
        ncb_from_any_source_at_entry: { title: 'Non-cash benefits from any source at entry', translator: ->(v) { "#{HudHelper.util.no_yes_reasons_for_missing_data(v)} (#{v})" } },
        ncb_from_any_source_at_annual: { title: 'Non-cash benefits from any source at annual assessment', translator: ->(v) { "#{HudHelper.util.no_yes_reasons_for_missing_data(v)} (#{v})" } },
        ncb_from_any_source_at_exit: { title: 'Non-cash benefits from any source at exit', translator: ->(v) { "#{HudHelper.util.no_yes_reasons_for_missing_data(v)} (#{v})" } },
        ...
        insurance_from_any_source_at_entry: { title: 'Insurance from any source at entry', translator: ->(v) { "#{HudHelper.util.no_yes_reasons_for_missing_data(v)} (#{v})" } },
        insurance_from_any_source_at_annual: { title: 'Insurance from any source at annual assessment', translator: ->(v) { "#{HudHelper.util.no_yes_reasons_for_missing_data(v)} (#{v})" } },
        insurance_from_any_source_at_exit: { title: 'Insurance from any source at exit', translator: ->(v) { "#{HudHelper.util.no_yes_reasons_for_missing_data(v)} (#{v})" } },
        ...
        percent_ami: { title: 'Income as a Percent of AMI', translator: ->(v) { "#{HudHelper.util.percent_ami(v)} (#{v})" } },
        vamc_station: { title: 'VAMC Station Number' },
        veteran: { title: 'Veteran', translator: ->(v) { "#{HudHelper.util.no_yes_reasons_for_missing_data(v)} (#{v})" } },
        hoh_veteran: { title: 'Head of Household is a Veteran' },
        hh_veteran_count: { title: 'Count of Veterans in Household' },
        target_screen_required: { title: 'Homelessness Prevention Targeting Screening is Required', translator: ->(v) { "#{HudHelper.util.no_yes(v)} (#{v})" } },
        ...
        afghanistan_oef: { title: 'Afghanistan (Operation Enduring Freedom)', translator: ->(v) { "#{HudHelper.util.no_yes_reasons_for_missing_data(v)} (#{v})" } },
        iraq_oif: { title: 'Iraq (Operation Iraqi Freedom)', translator: ->(v) { "#{HudHelper.util.no_yes_reasons_for_missing_data(v)} (#{v})" } },
    ...
    def report_item_fields_from_enrollment(report_items:, enrollment:, report:) # rubocop:disable Metrics/AbcSize, Metrics/CyclomaticComplexity, Metrics/PerceivedComplexity
      ...
      annual_expected = if annual_assessment_expected?(hoh_enrollment: hoh, enrollment: enrollment.service_history_enrollment, report_end_date: report.end_date) && stayer
      ...
      report_item.disability_at_entry_collected = enrollment.disabilities_at_entry.not_hiv&.map(&:DisabilityResponse)&.all? { |dr| dr.in?(HudHelper.util.disability_responses.keys - [99]) } || false
      ...
      lot = if project_type.in?(HudHelper.util.project_type_number_from_code(:es_nbn))
      ...
      max_service = if project_type.in?(HudHelper.util.project_type_number_from_code(:es_nbn))
        # most recent service, or start date if no service
        en_services.max_by(&:DateProvided)&.DateProvided || enrollment.EntryDate
      elsif enrollment.project.project_type_to_use.in?(HudHelper.util.project_type_number_from_code(:so))
    ...
    private def hp_targeting_criteria_complete(enrollment)
      ...
      return true unless (HudHelper.util.time_to_housing_losses.keys - [99]).include?(enrollment.TimeToHousingLoss) # V7.A
      return true unless (HudHelper.util.annual_percent_amis.keys - [99]).include?(enrollment.AnnualPercentAMI) # V7.B
      return true unless (HudHelper.util.literal_homeless_histories.keys - [99]).include?(enrollment.LiteralHomelessHistory) # V7.C
      ...
      return true unless (HudHelper.util.eviction_histories.keys - [99]).include?(enrollment.EvictionHistory) # V7.G
      return true unless valid_yes_no_missing_options.include?(enrollment.CriminalRecord) # V7.H
      return true unless (HudHelper.util.incarcerated_adults.keys - [99]).include?(enrollment.IncarceratedAdult) # V7.I
      ...
      return true unless (HudHelper.util.dependent_under_6_options.keys - [99]).include?(enrollment.DependentUnder6) # V7.O
    ...
    def self.chronic_denominator?(item)
      ...
      return true if HudHelper.util.chronic_project_types.include?(item.project_type)
    ...
    def self.sections(report) # rubocop:disable Metrics/AbcSize, Metrics/CyclomaticComplexity, Metrics/PerceivedComplexity
      {
        disabling_condition_issues: {
          ...
          limiter: ->(item) {
            ! HudHelper.util.no_yes_reasons_for_missing_data_options.key?(item.disabling_condition)
          },
        },
        hoh_validation_issues: {
          ...
          denominator: ->(_item) { true },
          limiter: ->(item) {
            ! HudHelper.util.relationships_to_hoh.key?(item.relationship_to_hoh)
          },
        },
        living_situation_issues: {
          ...
          limiter: ->(item) {
            ...
            ! (HudHelper.util.valid_prior_living_situations - [99]).include?(item.living_situation)
          },
        },
        exit_date_issues: {
          ...
          limiter: ->(item) {
            ...
            return item.exit_date <= item.entry_date if HudHelper.util.residential_project_type_ids.include?(item.project_type)
        ...
        destination_issues: {
          ...
          limiter: ->(item) {
            ...
            ! HudHelper.util.valid_destinations.key?(item.destination)
          },
        },
        ...
        hoh_income_percent_ami: {
          ...
          denominator: ->(item) {
            ...
            in_project_types = [
              ...
              HudHelper.util.performance_reporting[:prevention],
          ...
          limiter: ->(item) {
            ...
            ! (HudHelper.util.percent_amis.keys - [99]).include?(item.percent_ami)
          },
        },
        hp_targeting_criteria: {
          ...
          limiter: ->(item) {
            ...
            return true unless (HudHelper.util.yes_no_missing_options.keys - [99]).include?(item.target_screen_required)
        ...
        vamc_station: {
          ...
          denominator: ->(item) {
            funding_sources = [
              HudHelper.util.funder_components['HUD: HUD-VASH'],
              HudHelper.util.funder_components['VA: SSVF'],
              HudHelper.util.funder_components['VA: GPD'],
              HudHelper.util.funder_components['VA: CRS Contract Residential Services'],
              HudHelper.util.funder_components['VA: Community Contract Safe Haven'],
            ].flatten
            in_project_types = [
              HudHelper.util.performance_reporting[:es_entry_exit],
              HudHelper.util.performance_reporting[:th],
              HudHelper.util.performance_reporting[:psh],
              HudHelper.util.performance_reporting[:so],
              HudHelper.util.performance_reporting[:sh],
              HudHelper.util.performance_reporting[:oph],
              HudHelper.util.performance_reporting[:rrh],
            ].flatten.include?(item.project_type)
          ...
          limiter: ->(item) {
            ...
            ! (HudHelper.util.vamc_station_numbers.keys - [99]).include?(vamc_number)
          },
        },
        homeless_living_situation_issues: {
          ...
          denominator: ->(item) { adult?(item) && HudHelper.util.performance_reporting[:prevention].include?(item.project_type) },
          limiter: ->(item) {
            return false unless adult?(item)
            return false unless HudHelper.util.performance_reporting[:prevention].include?(item.project_type)
        ...
        non_homeless_living_situation_issues: {
          ...
          denominator: ->(item) { adult?(item) && HudHelper.util.performance_reporting[:rrh].include?(item.project_type) },
          limiter: ->(item) {
            return false unless adult?(item)
            return false unless HudHelper.util.performance_reporting[:rrh].include?(item.project_type)
        ...
        lot_es_90_issues: {
          ...
          denominator: ->(item) {
            HudHelper.util.residential_project_type_numbers_by_code[:es].include?(item.project_type)
          },
          limiter: ->(item) {
            return false if item.exit_date.present?

            item.lot >= 90 && HudHelper.util.residential_project_type_numbers_by_code[:es].include?(item.project_type)
          },
          es_stay_length: 90,
        },
        lot_es_180_issues: {
          ...
          limiter: ->(item) {
            ...
            item.lot >= 180 && HudHelper.util.residential_project_type_numbers_by_code[:es].include?(item.project_type)
          },
          es_stay_length: 180,
        },
        lot_es_365_issues: {
          ...
          limiter: ->(item) {
            ...
            item.lot >= 365 && HudHelper.util.residential_project_type_numbers_by_code[:es].include?(item.project_type)
          },
          es_stay_length: 365,
        },
        days_since_last_service_es_90_issues: {
          ...
          denominator: ->(item) {
            HudHelper.util.residential_project_type_numbers_by_code[:es_nbn].include?(item.project_type)
          },
          limiter: ->(item) {
            return false if item.exit_date.present?
            return false unless HudHelper.util.residential_project_type_numbers_by_code[:es_nbn].include?(item.project_type)
        ...
        days_since_last_service_so_90_issues: {
          ...
          denominator: ->(item) {
            HudHelper.util.residential_project_type_numbers_by_code[:so].include?(item.project_type)
          },
          limiter: ->(item) {
            return false if item.exit_date.present?

            item.days_since_last_service >= 90 && HudHelper.util.residential_project_type_numbers_by_code[:so].include?(item.project_type)
          },
        ...
        days_since_last_service_so_180_issues: {
          ...
          limiter: ->(item) {
            ...
            item.days_since_last_service >= 180 && HudHelper.util.residential_project_type_numbers_by_code[:so].include?(item.project_type)
          },
        ...
        days_since_last_service_so_365_issues: {
          ...
          limiter: ->(item) {
            ...
            item.days_since_last_service >= 365 && HudHelper.util.residential_project_type_numbers_by_code[:so].include?(item.project_type)
          },
        ...
        afghanistan_oef: {
          ...
          limiter: ->(item) {
            ...
            ! (HudHelper.util.yes_no_missing_options.keys - [99]).include?(item.afghanistan_oef)
          },
        },
        iraq_oif: {
          ...
          limiter: ->(item) {
            ...
            ! (HudHelper.util.yes_no_missing_options.keys - [99]).include?(item.iraq_oif)
          },
        },
        iraq_ond: {
          ...
          limiter: ->(item) {
            ...
            ! (HudHelper.util.yes_no_missing_options.keys - [99]).include?(item.iraq_ond)
          },
        },
        military_branch: {
          ...
          limiter: ->(item) {
            ...
            ! (HudHelper.util.military_branches.keys - [99]).include?(item.military_branch)
          },
        },
        discharge_status: {
          ...
          limiter: ->(item) {
            ...
            ! (HudHelper.util.discharge_statuses.keys - [99]).include?(item.discharge_status)
          },
        },
        employed: {
          title: 'Employed',
          ...
          denominator: ->(item) {
            funding_sources = [
              HudHelper.util.funder_components['HUD: HUD-VASH'],
              HudHelper.util.funder_components['HHS: RHY'],
              HudHelper.util.funder_components['VA: SSVF'],
              HudHelper.util.funder_components['VA: GPD'],
            ].flatten
          ...
          limiter: ->(item) {
            ...
            ! (HudHelper.util.yes_no_missing_options.keys - [99]).include?(item.employed)
          },
        },
