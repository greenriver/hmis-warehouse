...
RSpec.shared_context '2022 project id override tests', shared_context: :metadata do
...
RSpec.configure do |rspec|
  rspec.include_context '2022 project id override tests', include_shared: true
end
