...
RSpec.shared_context '2022 project type override tests', shared_context: :metadata do
...
RSpec.configure do |rspec|
  rspec.include_context '2022 project type override tests', include_shared: true
end
