RSpec.shared_context '2022 HMIS Participating Project override tests', shared_context: :metadata do
...
RSpec.configure do |rspec|
  rspec.include_context '2022 HMIS Participating Project override tests', include_shared: true
end
