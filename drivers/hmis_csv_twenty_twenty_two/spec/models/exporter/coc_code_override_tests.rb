...
RSpec.shared_context '2022 coc code override tests', shared_context: :metadata do
  describe 'When exporting enrollment related item' do
    ...
    end
    {
      enrollment_cocs: {
        ...
        export_class: HmisCsvTwentyTwentyTwo::Exporter::EnrollmentCoc,
      },
      inventories: {
        export_method: :export_inventories,
        export_class: HmisCsvTwentyTwentyTwo::Exporter::Inventory,
      },
      project_cocs: {
...
RSpec.configure do |rspec|
  rspec.include_context '2022 coc code override tests', include_shared: true
end
