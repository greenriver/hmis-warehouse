...
Rails.application.config.hmis_importers['2022'] = 'HmisCsvImporter::Importer::Importer'
Rails.application.config.hmis_loaders['2022'] = 'HmisCsvImporter::Loader::Loader'
