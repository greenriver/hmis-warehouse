...
module
  ...
  included do
    ...
    def ethnicity_buckets
      @ethnicity_buckets ||= ::HudHelper.util.ethnicities.merge(dont_know: "Don't know", prefers_not_to_answer: 'Prefers not to answer', not_collected: 'Data not collected').except(:unknown)
    end
