...
module
  ...
  included do
    ...
    private def gender_column_to_numeric(column)
      HudHelper.util.gender_id_to_field_name.detect { |_, l| l == column }.first
    end
        ...
        {}.tap do |clients|
          ...
          report_scope.joins(:client).order(first_date_in_program: :desc).
            ...
            each do |row|
              ...
              # HudHelper.util.gender_id_to_field_name includes multiple :GenderNone records. We are mapping
