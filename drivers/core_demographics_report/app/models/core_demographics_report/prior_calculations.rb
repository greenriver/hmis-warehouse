...
module
  ...
  included do
    ...
    def prior_detail_hash
      {}.tap do |hashes|
        ::HudUtilityCurrent.times_homeless_options.each do |id, title|
        ...
        ::HudUtilityCurrent.month_categories.each do |id, title|
        ...
        ::HudUtilityCurrent.living_situations.each do |id, title|
