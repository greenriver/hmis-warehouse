  ...
  class Importer
    ...
    private def post_process
      ...
      updated_client_ids = GrdaWarehouse::Hud::Client.
        ...
        where(PersonalID: HmisCsvTwentyTwenty::Importer::InvolvedInImport.changed_personal_ids(importer_log.id), data_source_id: @data_source.id).
