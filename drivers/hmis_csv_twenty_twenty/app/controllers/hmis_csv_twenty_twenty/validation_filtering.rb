...
module HmisCsvTwentyTwenty::ValidationFiltering
  extend ActiveSupport::Concern

  included do
    private def detect_filename
      filename = params[:file] + '.csv'
      HmisCsvTwentyTwenty::Importer::Importer.importable_files_map.keys.detect { |v| v == filename }
    end

    private def pattern
      '%::' + HmisCsvTwentyTwenty::Importer::Importer.importable_files_map[@filename].downcase
    end
