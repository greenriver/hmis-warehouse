RSpec.shared_context '2020 project coc zip override tests', shared_context: :metadata do
...
RSpec.configure do |rspec|
  rspec.include_context '2020 project coc zip override tests', include_shared: true
end
