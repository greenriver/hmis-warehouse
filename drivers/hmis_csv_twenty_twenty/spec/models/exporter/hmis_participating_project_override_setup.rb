RSpec.shared_context '2020 HMIS Participating Project override setup', shared_context: :metadata do
...
RSpec.configure do |rspec|
  rspec.include_context '2020 HMIS Participating Project override setup', include_shared: true
end
