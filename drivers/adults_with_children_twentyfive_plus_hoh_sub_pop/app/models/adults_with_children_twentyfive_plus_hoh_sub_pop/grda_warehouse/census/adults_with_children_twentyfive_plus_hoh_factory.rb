...
module AdultsWithChildrenTwentyfivePlusHohSubPop::GrdaWarehouse::Census
  class AdultsWithChildrenTwentyfivePlusHohFactory
    def self.get_client_counts(batch, project_type)
      batch.get_client_counts(project_type, :service_history_enrollment, GrdaWarehouse::ServiceHistoryEnrollment.adults_with_children_twentyfive_plus_hoh)
    end

    def self.get_homeless_client_counts(batch)
      batch.get_aggregate_client_counts(
        joins: :service_history_enrollment,
        client_scope: GrdaWarehouse::ServiceHistoryEnrollment.adults_with_children_twentyfive_plus_hoh,
