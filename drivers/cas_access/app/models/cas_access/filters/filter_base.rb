...
module CasAccess::Filters
  class FilterBase < ::ModelForm
    ...
    def gender_options_for_select
      HudUtilityCurrent.gender_field_name_label.transform_keys { |k| k.to_s.underscore.to_sym }.except(:gender_none).invert.freeze
    end
    ...
    def race_options_for_select
      HudUtilityCurrent.races.transform_keys { |k| k.underscore.to_sym }.except(:race_none).invert.freeze
    end
