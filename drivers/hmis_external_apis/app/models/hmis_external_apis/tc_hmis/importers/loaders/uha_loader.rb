  ...
  class UhaLoader < CustomAssessmentLoader
    ...
    CDED_CONFIGS =
      [
        ...
        { label: 'Unique Enrollment Identifier', key: 'uha_unique_enrollment_identifier', repeats: false, field_type: 'string' },
        { label: 'Response ID', key: 'uha_response_id', repeats: false, field_type: 'string' },
        { label: 'Date Taken', key: 'uha_date_taken', repeats: false, field_type: 'date' },
        ...
        { element_id: 12283, label: 'Alternate Phone Number', key: 'uha_alternate_phone_number', repeats: false, field_type: 'string' },
        { element_id: 12284, label: 'Disabled:', key: 'uha_disabled', repeats: false, field_type: 'string' },
        { element_id: 12285, label: 'Marital Satus:', key: 'uha_marital_status', repeats: false, field_type: 'string' },
        { element_id: 12286,
          label: 'Citizenship: Are you and all family members a U.S. Citizen or have eligible immigration status?',
          key: 'uha_key_12286',
          repeats: false,
          field_type: 'string' },
        { element_id: 12287,
        ...
        { element_id: 13098, label: 'For out of state searches - list cities, counties, and states below:', key: 'uha_cch_key_13098', repeats: false, field_type: 'string' },
