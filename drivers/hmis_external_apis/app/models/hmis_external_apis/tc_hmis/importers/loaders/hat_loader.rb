...
module HmisExternalApis::TcHmis::Importers::Loaders
  class HatLoader < CustomAssessmentLoader
    ...
    CDED_CONFIGS = [
      ...
      { element_id: 13108, key: 'hat_a8_household_size', label: "How many household members (including minor children) do you expect to live with you when you're housed?", repeats: false, field_type: 'integer' },
      ...
      { element_id: 12180, key: 'hat_a11_unable_to_live_alone', label: 'Client is unable to live alone', repeats: false, field_type: 'boolean' },
      { element_id: 12181, key: 'hat_a12_unable_to_live_alone_reason', label: '[STAFF RESPONSE] Explain why this client cannot live independently.', repeats: false, field_type: 'string' },
      ...
      { element_id: 12162, key: 'hat_c2_able_to_work_full_time', label: '[STAFF RESPONSE] Is the client **able** to work a full-time?', repeats: false, field_type: 'boolean' },
      { element_id: 12163, key: 'hat_c3_willing_to_work_full_time', label: '[STAFF RESPONSE] Is the client **willing** to work a full-time?', repeats: false, field_type: 'boolean' },
      { element_id: 12199, key: 'hat_c4_reason_not_working_full_time', label: '[CLIENT RESPONSE] If you can work and are willing to work a full time job, why are you not working right now?', repeats: false, field_type: 'string' },
      ...
      { element_id: 12216, key: 'hat_c8_history_of_drug_use', label: '[CLIENT RESPONSE] Do you have a history of heavy drug use? (Use that has affected your ability to work and/or maintain housing?)', repeats: false, field_type: 'boolean' },
      { element_id: 12217, key: 'hat_c9_sober_for_one_year', label: '[CLIENT RESPONSE] Have you been clean/sober for at least one year?', repeats: false, field_type: 'boolean' },
      { element_id: 12218, key: 'hat_c10_willing_to_engage_case_management', label: '[CLIENT RESPONSE] Are you willing to engage with housing case management? (Would you participate in a program, goal setting, etc.?)', repeats: false, field_type: 'boolean' },
      ...
      { element_id: 12156, key: 'hat_d1_disabling_condition_indefinite_impairs',
      ...
      { element_id: 12195, key: 'hat_e1_client_history', label: 'Client History (Check all that apply)', repeats: true, field_type: 'string' },
      { element_id: 12880, key: 'hat_e2_homelessness_cause_jail', label: 'You have indicated your client has had one or more stays in prison/jail/correctional facility in their lifetime. Did this cause their current episode of homelessness?', repeats: false, field_type: 'boolean' },
      ...
      { element_id: 12884, key: 'hat_e6_homelessness_cause_chronic_health', label: 'You have indicated that a household member is living with a chronic health condition that is disabling. Did this cause their current episode of homelessness?', repeats: false, field_type: 'boolean' },
      ...
      { element_id: 12221, key: 'hat_e13_ipv_fleeing', label: '[CLIENT RESPONSE] You indicated a history of Intimate Partner Violence (IPV). Are you currently fleeing?', repeats: false, field_type: 'boolean' },
      ...
      { element_id: 12154, key: 'hat_f1_housing_preference', label: 'Housing Preference (Check all that apply)', repeats: true, field_type: 'string' },
      { element_id: 12158, key: 'hat_f2_other_housing_preference', label: 'Housing Preference if Other', repeats: false, field_type: 'string' },
      { element_id: 12184, key: 'hat_f3_housing_location_preference', label: "Housing Location Preference (Select ONE or 'No Preference' if more than one)", repeats: false, field_type: 'string' },
      ...
      { element_id: 12197, key: 'hat_f5_preferred_neighborhood', label: 'Preferred Neighborhood', repeats: false, field_type: 'string' },
