...
module HmisExternalApis::TcHmis::Importers::Loaders
  class CustomDataElementDefinitions
    ...
    def configs
      [].map do |key|
        { owner_type: 'Hmis::Hud::CustomAssessment', field_type: :string, key: :key, repeats: false, label: :flex_funds_types.to_s.humanize },
      end
      [
        { owner_type: 'Hmis::Hud::CustomAssessment', field_type: :string, key: :flex_funds_types, repeats: true, label: :flex_funds_types.to_s.humanize },
