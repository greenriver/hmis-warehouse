  ...
  class ReferralPosting < ::HmisExternalApis::HmisExternalApisBase
    ...
    enum(
      status: {
        ...
        accepted_status: 20,
        denied_status: 21,
        # The below statuses are present in the LINK system, but we don't interface with them.
      ...
      referral_result: ::HudUtilityCurrent.hud_list_map_as_enumerable(:referral_results),
    )
