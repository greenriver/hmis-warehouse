...
module BostonProjectScorecard::WarehouseReports
  class ScorecardsController < ApplicationController
    ...
    def show
      ...
      @pdf_export = BostonProjectScorecard::DocumentExports::ScorecardExport.new(query_string: report_id.to_query, user: current_user)
    end
    ...
    def create
      ...
      if errors.any?
        ...
        redirect_to(boston_project_scorecard_warehouse_reports_scorecards_path(filters: initial_filter_params))
      end
    end
