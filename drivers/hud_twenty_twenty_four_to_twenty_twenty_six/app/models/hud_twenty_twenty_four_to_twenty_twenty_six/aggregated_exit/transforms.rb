...
module HudTwentyTwentyFourToTwentyTwentySix::AggregatedExit
  class Transforms
    def self.transforms(csv: false, db: false, references: {}) # rubocop:disable Lint/UnusedMethodArgument, Naming/MethodParameterName
      [
        HudTwentyTwentyFourToTwentyTwentySix::AggregatedExit::AddDestinationSubsidyType,
        HudTwentyTwentyFourToTwentyTwentySix::AggregatedExit::UpdateDestination, # Done last as it overwrites destination
      ]
    end
