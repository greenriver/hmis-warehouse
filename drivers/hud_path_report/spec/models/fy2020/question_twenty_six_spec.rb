...
RSpec.describe HudPathReport::Generators::Fy2020::QuestionTwentySix, type: :model do
  include_context 'path context'

  before(:all) do
    default_setup
    run(default_filter, HudPathReport::Generators::Fy2020::QuestionTwentySix::QUESTION_NUMBER)
  end
  ...
  describe 'soar connection' do
    ...
    it 'counts clients' do
      expect(report_result.answer(question: 'Q26', cell: 'C52').summary).to eq(1)
    end
  end
