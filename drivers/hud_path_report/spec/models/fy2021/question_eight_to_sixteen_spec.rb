...
RSpec.describe HudPathReport::Generators::Fy2021::QuestionEightToSixteen, type: :model do
  include_context 'path context FY2021'

  before(:all) do
    default_setup
    run(default_filter, HudPathReport::Generators::Fy2021::QuestionEightToSixteen::QUESTION_NUMBER)
  end
