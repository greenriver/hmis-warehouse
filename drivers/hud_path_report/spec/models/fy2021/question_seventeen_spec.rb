...
RSpec.describe HudPathReport::Generators::Fy2021::QuestionSeventeen, type: :model, ci_bucket: 'bucket-2' do
  include_context 'path context FY2021'

  before(:all) do
    default_setup
    run(default_filter, HudPathReport::Generators::Fy2021::QuestionSeventeen::QUESTION_NUMBER)
  end
