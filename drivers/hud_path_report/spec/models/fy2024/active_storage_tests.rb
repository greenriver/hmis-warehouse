...
RSpec.shared_context 'active storage tests hud path report', shared_context: :metadata do
  describe 'HUD PATH Report ActiveStorage Migration Tests' do
    before(:all) do
    ...
    it 'runs HUD PATH Report and stores artifacts to ActiveStorage' do
    ...
    it 'verifies RDS data is cleaned up after artifact storage' do
      ...
      expect(HudPathReport::Fy2020::PathClient.where(report_instance_id: @report.id)).to be_empty
    end
