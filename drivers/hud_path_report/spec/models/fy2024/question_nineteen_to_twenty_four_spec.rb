...
RSpec.describe HudPathReport::Generators::Fy2024::QuestionNineteenToTwentyFour, type: :model do
  include_context 'path context FY2024'

  before(:all) do
    default_setup
    run(default_filter, HudPathReport::Generators::Fy2024::QuestionNineteenToTwentyFour::QUESTION_NUMBER)
  end
