...
RSpec.shared_context 'parenting youth', shared_context: :metadata do
  describe 'Parenting Youth Households:' do
    let(:question) { HudPit::Generators::Pit::Fy2024::ParentingYouth::QUESTION_NUMBER }
    let(:column_names) do
      {
        'Emergency': 'B',
        'Transitional': 'C',
    ...
    describe 'Number of parenting youth (youth parents only):' do
      let(:row_number) { 4 }
      it 'Emergency' do
        result = cell_result(question: question, cell_name: column_names[:Emergency] + row_number.to_s)
        expect(result).to eq(9)
    ...
    describe 'Total Children in Parenting Youth Households:' do
      let(:row_number) { 5 }
      it 'Emergency' do
        result = cell_result(question: question, cell_name: column_names[:Emergency] + row_number.to_s)
    ...
    describe 'Number of parenting youth (under age 18):' do
      let(:row_number) { 6 }
      it 'Emergency' do
        result = cell_result(question: question, cell_name: column_names[:Emergency] + row_number.to_s)
        expect(result).to eq(0)
    ...
    describe 'Children in households with parenting youth under age 18 (children under age 18 with parents under 18):' do
      let(:row_number) { 7 }
      it 'Emergency' do
        result = cell_result(question: question, cell_name: column_names[:Emergency] + row_number.to_s)
        expect(result).to eq(0)
    ...
    describe 'Number of parenting youth (age 18 to 24):' do
      let(:row_number) { 8 }
      it 'Emergency' do
        result = cell_result(question: question, cell_name: column_names[:Emergency] + row_number.to_s)
        expect(result).to eq(9)
    ...
    describe 'Children in households with parenting youth age 18 to 24 (children under age 18 with parents age 18 to 24):' do
      let(:row_number) { 9 }
      it 'Emergency' do
        result = cell_result(question: question, cell_name: column_names[:Emergency] + row_number.to_s)
        expect(result).to eq(16)
