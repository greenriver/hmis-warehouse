...
RSpec.shared_context 'veteran adult and child', shared_context: :metadata do
  describe 'Adult & Child Veteran Households (at least one adult and one child):' do
    question = HudPit::Generators::Pit::Fy2025::VeteranAdultAndChild::QUESTION_NUMBER
    column_names = {
      'Emergency': 'B',
      'Transitional': 'C',
      'Outreach': 'D',
    ...
    results = {
      'Total Number of Households' => [0, 1, 0],
      'Total Number of Persons' => [0, 2, 0],
      'Total Number of Veterans' => [0, 1, 0],
      # 'Woman (Girl, if child)' => [0, 1, 0],
      ...
      'Black, African American, or African (only)' => [0, 0, 0],
      ...
      'Native Hawaiian or Pacific Islander (only)' => [0, 0, 0],
      'Native Hawaiian or Pacific Islander & Hispanic/Latina/e/o' => [0, 0, 0],
      'White (only)' => [0, 1, 0],
      'White & Hispanic/Latina/e/o' => [0, 0, 0],
      'Multi-Racial & Hispanic/Latina/e/o' => [0, 0, 0],
