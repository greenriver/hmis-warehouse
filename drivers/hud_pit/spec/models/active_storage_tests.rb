...
RSpec.shared_context 'active storage tests hud pit', shared_context: :metadata do
  describe 'HUD PIT Report ActiveStorage Migration Tests' do
    before(:all) do
    ...
    it 'runs HUD PIT Report and stores artifacts to ActiveStorage' do
    ...
    it 'verifies RDS data is cleaned up after artifact storage' do
      ...
      expect(HudPit::Fy2024::PitClient.where(report_instance_id: @report.id)).to be_empty
    end
