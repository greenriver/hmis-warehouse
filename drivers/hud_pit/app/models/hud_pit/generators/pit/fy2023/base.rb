...
module HudPit::Generators::Pit::Fy2023
  class Base < ::HudReports::QuestionBase
    ...
    private def add
      @generator.client_scope.find_in_batches(batch_size: batch_size) do |batch|
        ...
        batch.each do |client|
          ...
          pit_gender = HudHelper.util('legacy').gender(source_client.gender_binary)
    ...
    private def enrollment_from(enrollments)
      ...
      last_service_history_enrollment ||= enrollments.reverse_each.detect { |en| en.project_type == PROJECT_TYPES[:es] }
    ...
    private def sub_calculations
      {
        ...
        non_latino: {
          title: 'Non-Hispanic/Latin(a)(o)(x)',
