...
module HudSpmReport::Fy2026
  class EpisodeBatch
    ...
    def calculate_batch(client_ids)
      ...
      enrollments_for_clients = @enrollments.where(client_id: client_ids).
        order(:entry_date, :enrollment_id, :id).
        preload(:client, :enrollment).group_by(&:client_id)
      ...
      client_ids.each do |client_id|
        ...
        episode_calculations = HudSpmReport::Fy2026::Episode.new(client: client, report: @report, filter: @filter, services: batch_services).
          compute_episode(
