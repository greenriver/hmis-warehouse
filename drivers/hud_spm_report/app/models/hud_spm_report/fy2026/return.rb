  ...
  class Return < HudReports::ReportClientBase
    ...
    def compute_return(enrollments)
      ...
      self.return_enrollment = candidate_returns.detect do |enrollment|
        ...
        enrollment.project_type.in?(HudHelper.util('2026').homeless_project_type_numbers) ||
          (enrollment.project_type.in?(HudHelper.util('2026').project_type_number_from_code(:ph)) &&
