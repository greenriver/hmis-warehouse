...
module HudSpmReport::Generators::Fy2026
  class MeasureTwo < MeasureBase
    ...
    private def a_t
      @a_t ||= HudSpmReport::Fy2026::Return.arel_table
    end

    private def report_rows
      {
        2 => HudHelper.util('2026').project_type_number_from_code(:so),
        3 => HudHelper.util('2026').project_type_number_from_code(:es),
        4 => HudHelper.util('2026').project_type_number_from_code(:th),
        5 => HudHelper.util('2026').project_type_number_from_code(:sh),
        6 => HudHelper.util('2026').project_type_number_from_code(:ph),
      }.freeze
    end
