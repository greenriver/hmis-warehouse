...
RSpec.describe 'HUD SPM Universe', type: :model do
  ...
  #     client = GrdaWarehouse::Hud::Client.destination.first
  #     enrollments = HudSpmReport::Fy2024::SpmEnrollment.all
  #     return_to_homelessness = HudSpmReport::Fy2024::Return.new(report_instance: @report_result, client: client).compute_return(enrollments)
