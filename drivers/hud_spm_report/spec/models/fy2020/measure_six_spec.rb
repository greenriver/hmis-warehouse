...
RSpec.describe HudSpmReport::Generators::Fy2020::MeasureSix, type: :model do
  ...
  [
    ...
    ['6a.1 and 6b.1', 'H5', 0, '% returning in 13-24mo from SH'],
    ['6a.1 and 6b.1', 'H6', 0, '% returning in 13-24mo from PH'],
    ['6a.1 and 6b.1', 'H7', 0, '% returning in 13-24mo'],
    ...
    ['6a.1 and 6b.1', 'J5', 0, '% returning in <2yr from SH'],
    ['6a.1 and 6b.1', 'J6', 0, '% returning in <2yr from SO'],
    ['6a.1 and 6b.1', 'J7', 0, '% returning in <2yr'],
