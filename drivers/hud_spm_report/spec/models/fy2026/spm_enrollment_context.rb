...
RSpec.shared_context 'FY2026 SPM enrollment context', shared_context: :metadata do
  ...
  def setup(export_directory)
    ...
    if warehouse_fixture.exists? && app_fixture.exists?
      ...
      export_path = "drivers/hud_spm_report/spec/fixtures/files/fy2026/#{export_directory}"
