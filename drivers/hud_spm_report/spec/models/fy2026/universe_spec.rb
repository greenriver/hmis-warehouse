...
RSpec.describe 'HUD SPM Universe', type: :model do
  include_context 'FY2026 SPM enrollment context'

  # Using TestKit instead
  ...
  #     run(filter, nil)
  #     HudSpmReport::Fy2026::SpmEnrollment.create_enrollment_set(@report_result)
  #   end

  #   it 'creates enrollments' do
  #     expect(HudSpmReport::Fy2026::SpmEnrollment.count).to eq(6)
  #   end

  #   it 'creates an episode' do
  #     client = GrdaWarehouse::Hud::Client.destination.first
  #     episode = HudSpmReport::Fy2026::Episode.create(report: @report_result, client: client)
  #     episode.compute_episode(
  #       HudSpmReport::Fy2026::SpmEnrollment.where(client_id: client.id).to_a,
  ...
  #     client = GrdaWarehouse::Hud::Client.destination.first
  #     enrollments = HudSpmReport::Fy2026::SpmEnrollment.all
  #     return_to_homelessness = HudSpmReport::Fy2026::Return.new(report_instance: @report_result, client: client).compute_return(enrollments)
