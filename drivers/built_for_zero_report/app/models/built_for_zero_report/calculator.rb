    ...
    def lot_to_housing
      @lot_to_housing ||= begin
        ...
        first_enrollment_dates = GrdaWarehouse::ServiceHistoryEnrollment.
          ...
          where(e_t[:LivingSituation].in(HudUtility2024.homeless_situations(as: :prior))).
        ...
        homeless_contact_dates = GrdaWarehouse::ServiceHistoryEnrollment.
          ...
          entry.
          where(client_id: housed.keys).
          where(cls_t[:CurrentLivingSituation].in(HudUtility2024.homeless_situations(as: :current))).
          group(:client_id).
