...
module HmisCsvTwentyTwentyFour::Importer
  class Inventory < GrdaWarehouse::Hud::Base
    ...
    self.table_name = 'hmis_2024_inventories'
    ...
    def self.hmis_validations
      {
        ...
        HouseholdType: [
          ...
          {
            class: HmisCsvImporter::HmisCsvValidation::InclusionInSet,
            arguments: { valid_options: HudHelper.util('2024').household_types.keys.map(&:to_s).freeze },
          },
        ],
        Availability: [
          {
            class: HmisCsvImporter::HmisCsvValidation::InclusionInSet,
            arguments: { valid_options: HudHelper.util('2024').availabilities.keys.map(&:to_s).freeze },
          },
        ],
        UnitInventory: [
          class: HmisCsvImporter::HmisCsvValidation::NonBlankValidation,
