...
module HmisCsvTwentyTwentyFour::Importer
  class Disability < GrdaWarehouse::Hud::Base
    ...
    self.table_name = 'hmis_2024_disabilities'
    self.primary_key = 'id'
    ...
    def self.hmis_validations
      {
        ...
        DataCollectionStage: [
          ...
          },
          {
            ...
            arguments: { valid_options: HudHelper.util('2024').data_collection_stages.keys.map(&:to_s).freeze },
          },
        ],
        DisabilityType: [
          {
          ...
          {
            class: HmisCsvImporter::HmisCsvValidation::InclusionInSet,
            arguments: { valid_options: HudHelper.util('2024').disability_types.keys.map(&:to_s).freeze },
          },
        ],
        DisabilityResponse: [
          {
          ...
          {
            class: HmisCsvImporter::HmisCsvValidation::InclusionInSet,
            arguments: { valid_options: HudHelper.util('2024').disability_responses.keys.map(&:to_s).freeze },
          },
        ],
