    ...
    def self.hmis_validations
      {
        ...
        AssessmentType: [
          ...
          },
          {
            ...
            arguments: { valid_options: Hud.util('2024').assessment_types.keys.map(&:to_s).freeze },
          },
        ],
        AssessmentLevel: [
          {
          ...
          {
            class: HmisCsvImporter::HmisCsvValidation::InclusionInSet,
            arguments: { valid_options: Hud.util('2024').assessment_levels.keys.map(&:to_s).freeze },
          },
        ],
        PrioritizationStatus: [
          ...
          {
            class: HmisCsvImporter::HmisCsvValidation::InclusionInSet,
            arguments: { valid_options: Hud.util('2024').prioritization_statuses.keys.map(&:to_s).freeze },
          },
        ],
      }
    end
