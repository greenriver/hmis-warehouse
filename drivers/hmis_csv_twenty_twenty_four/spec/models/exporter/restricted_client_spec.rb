...
RSpec.describe HmisCsvTwentyTwentyFour::Exporter::Base, type: :model do
  before(:all) do
    ...
    @restricted_source_client = ExportHelper2024.clients.first
  ...
  def client_rows(exporter)
    CSV.read(ExportHelper2024.csv_file_path(ExportHelper2024.client_class, exporter: exporter), headers: true)
  end
  ...
  describe 'a plain export' do
    ...
    it 'leaves an unrestricted client row untouched' do
      unrestricted_source_client = ExportHelper2024.clients.second
