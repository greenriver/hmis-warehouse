...
RSpec.describe HudDataQualityReport::Generators::Fy2021::QuestionSix, type: :model do
  include_context 'dq context FY2021'

  before(:all) do
    default_setup
    run(default_filter, HudDataQualityReport::Generators::Fy2021::QuestionSix::QUESTION_NUMBER)
  end
