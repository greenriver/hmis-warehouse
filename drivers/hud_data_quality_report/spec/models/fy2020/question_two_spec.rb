...
RSpec.describe HudDataQualityReport::Generators::Fy2020::QuestionTwo, type: :model do
  include_context 'dq context'

  before(:all) do
    default_setup
    run(default_filter, HudDataQualityReport::Generators::Fy2020::QuestionTwo::QUESTION_NUMBER)
  end
