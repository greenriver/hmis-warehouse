...
module MaReports::CsgEngage::ReportComponents
  class HouseholdMember < Base
    ...
    def gender_fields
      client.attributes.slice(*HudHelper.util.gender_id_to_field_name.values.reject { |v| v == :GenderNone }.uniq.map(&:to_s))
    end

    def race_fields
      client.attributes.slice(*HudHelper.util.race_id_to_field_name.values.reject { |v| v == :RaceNone }.uniq.map(&:to_s))
    end
