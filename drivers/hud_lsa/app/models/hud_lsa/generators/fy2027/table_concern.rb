...
module HudLsa::Generators::Fy2027::TableConcern
  ...
  def setup_lsa_table_structure
    ::Rds.identifier = sql_server_identifier unless Rds.static_rds?
    ::Rds.database = sql_server_database
    load 'lib/rds_sql_server/lsa/fy2027/lsa_table_structure.rb'
  end
  ...
  def setup_lsa_table_indexes
    SqlServerBase.connection.execute <<~SQL
      #{File.read('lib/rds_sql_server/lsa/fy2027/sample_code/00 Totally Optional HMIS Table Indexes.sql')}
    SQL
    SqlServerBase.connection.execute(<<~SQL)
