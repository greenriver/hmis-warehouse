...
# r = HudLsa::Generators::Fy2026::Lsa.last
...
module HudLsa::Generators::Fy2026
  class Lsa < ::HudReports::ReportInstance
    ...
    has_one :summary_result, class_name: 'HudLsa::Fy2026::SummaryResult', foreign_key: :hud_report_instance_id
    ...
    def run_lsa_queries
      ...
      load 'lib/rds_sql_server/lsa/fy2026/lsa_queries.rb'
    ...
    def fetch_summary_results
      load 'lib/rds_sql_server/lsa/fy2026/lsa_report_summary.rb'
    ...
    def populate_hmis_tables
      load 'lib/rds_sql_server/lsa/fy2026/hmis_sql_server.rb' # provides thin wrappers to all HMIS tables
    ...
    memoize private def extract_path
      ...
      source = Rails.root.join('drivers/hud_lsa/spec/fixtures/files/lsa/fy2026/sample_hmis_export/')
    ...
    def fetch_results
      load 'lib/rds_sql_server/lsa/fy2026/lsa_sql_server.rb'
