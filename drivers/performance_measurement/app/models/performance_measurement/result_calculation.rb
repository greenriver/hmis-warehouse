...
module PerformanceMeasurement::ResultCalculation
  ...
  included do
    ...
    def increased_income(income_field, status_field, meth, project: nil)
      reporting_denominator = client_count(status_field, :reporting, project_id: project&.id)
      comparison_denominator = client_count(status_field, :comparison, project_id: project&.id)
      reporting_numerator = client_count(income_field, :reporting, project_id: project&.id)
      comparison_numerator = client_count(income_field, :comparison, project_id: project&.id)
