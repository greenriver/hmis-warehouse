...
module PerformanceMeasurement::ResultCalculation
  ...
  included do
    ...
    def length_of_homeless_stay_average(project_id: nil)
      ...
      reporting_count = client_count_present(field, :reporting, project_id: project_id)
      comparison_count = client_count_present(field, :comparison, project_id: project_id)
