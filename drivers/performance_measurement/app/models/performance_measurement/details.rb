    ...
    private def detail_hash
      @detail_hash ||= {
        ...
        th_average_bed_utilization: {
          ...
          # TODO: add markdown suppport to bold goals
        ...
        length_of_homeless_stay_average: {
          ...
          goal_description: 'Persons in the CoC will have an average combined length of stay project of **no more than %{goal} days** in a homeless project (SO, ES, SH, or TH).',
        ...
        length_of_homeless_stay_median: {
          ...
          goal_description: 'Persons in the CoC will have a median combined length of stay project of **no more than %{goal} days** in a homeless project (SO, ES, SH, or TH).',
          goal_calculation: :time_stay,
          denominator_label: '',
          calculation_description: 'A count of unique dates homeless.',
          calculation_column: :days_in_homeless_bed,
        ...
        time_to_move_in_average: {
          ...
          sub_category: 'Time',
          column: :system,
          title: 'Time Homeless (Average Days)',
        ...
        time_to_move_in_median: {
          ...
          sub_category: 'Time',
          column: :system,
          title: 'Time Homeless (Median Days)',
