    ...
    private def detail_hash
      @detail_hash ||= {
        ...
        length_of_homeless_stay_average: {
          ...
          goal_description: 'Persons in the CoC will have an average combined length of stay project of no more than %{goal} days.',
        ...
        length_of_homeless_stay_median: {
          ...
          goal_description: 'Persons in the CoC will have a median combined length of stay project of no more than %{goal} days.',
          goal_calculation: :time_stay,
          denominator_label: '',
          calculation_description: 'A count of unique dates homeless.',
          calculation_column: :days_in_homeless_bed,
