...
module HmisCsvTwentyTwentySix::Importer
  class Disability < GrdaWarehouse::Hud::Base
    ...
    self.table_name = 'hmis_2026_disabilities'
    self.primary_key = 'id'
    ...
    def self.hmis_validations
      {
        ...
        DataCollectionStage: [
          ...
          },
          {
            ...
            arguments: { valid_options: Hud.util('2026').data_collection_stages.keys.map(&:to_s).freeze },
          },
        ],
        DisabilityType: [
          {
          ...
          {
            class: HmisCsvImporter::HmisCsvValidation::InclusionInSet,
            arguments: { valid_options: Hud.util('2026').disability_types.keys.map(&:to_s).freeze },
          },
        ],
        DisabilityResponse: [
          {
          ...
          {
            class: HmisCsvImporter::HmisCsvValidation::InclusionInSet,
            arguments: { valid_options: Hud.util('2026').disability_responses.keys.map(&:to_s).freeze },
          },
        ],
