    ...
    def self.hmis_validations
      {
        ...
        HouseholdType: [
          ...
          {
            class: HmisCsvImporter::HmisCsvValidation::InclusionInSet,
            arguments: { valid_options: HudHelper.util('2026').household_types.keys.map(&:to_s).freeze },
          },
        ],
        Availability: [
          {
            class: HmisCsvImporter::HmisCsvValidation::InclusionInSet,
            arguments: { valid_options: HudHelper.util('2026').availabilities.keys.map(&:to_s).freeze },
          },
        ],
        UnitInventory: [
          class: HmisCsvImporter::HmisCsvValidation::NonBlankValidation,
