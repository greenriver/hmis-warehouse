...
module HmisCsvTwentyTwentySix::Importer
  class Exit < GrdaWarehouse::Hud::Base
    ...
    belongs_to :enrollment, primary_key: [:EnrollmentID, :PersonalID, :data_source_id, :importer_log_id], foreign_key: [:EnrollmentID, :PersonalID, :data_source_id, :importer_log_id], class_name: 'HmisCsvTwentyTwentySix::Importer::Enrollment', autosave: false, optional: true
