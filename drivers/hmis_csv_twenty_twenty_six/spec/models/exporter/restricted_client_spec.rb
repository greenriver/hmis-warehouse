...
RSpec.describe HmisCsvTwentyTwentySix::Exporter::Base, type: :model do
  before(:all) do
    ...
    @restricted_source_client = ExportHelper2026.clients.first
  ...
  def client_rows(exporter)
    CSV.read(ExportHelper2026.csv_file_path(ExportHelper2026.client_class, exporter: exporter), headers: true)
  end
  ...
  describe 'a plain export' do
    ...
    it 'leaves an unrestricted client row untouched' do
      unrestricted_source_client = ExportHelper2026.clients.second
