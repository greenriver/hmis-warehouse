...
module ClaimsReporting
  class PerformanceReport
    ...
    def filter_inputs
      {
        age_bucket: {
          label: Translation.translate('Age'),
        ...
        gender: {
          label: Translation.translate('Gender'),
        ...
        race: {
          label: Translation.translate('Race'),
        ...
        # aco: {
        #   label: Translation.translate('ACO'),
        ...
        #   label: Translation.translate('Mental Health Diagnosis Category'),
        ...
        #   label: Translation.translate('Medical Diagnosis Category'),
