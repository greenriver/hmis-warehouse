...
RSpec.describe HopwaCaper::Generators::Fy2026::Sheets::StTfbhSheet, type: :model do
  ...
  let(:activity_label) { 'Transitional/Short-Term' }
  let(:activity_label_long) { 'short-term/transitional facility-based housing' }
  ...
  it 'correctly attributes data to multiple facilities' do
    ...
    project2 = create_hopwa_project(funder: funder).tap do |p|
      p.update!(HousingType: 1, project_name: 'Second ST-TFBH Facility')
    end
