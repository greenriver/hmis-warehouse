  ...
  class SupportiveServicesSheet < Base
    ...
    def relevant_services
      @relevant_services ||= begin
        record_filter = HopwaCaper::Generators::Fy2024::ServiceFilters::RecordTypeFilter.hopwa_service
    ...
    def service_type_filters
      HopwaCaper::Generators::Fy2024::ServiceFilters::SupportiveServiceTypeFilter
    end
  end
end
