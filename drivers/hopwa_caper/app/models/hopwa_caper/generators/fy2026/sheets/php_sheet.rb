...
module HopwaCaper::Generators::Fy2026::Sheets
  class PhpSheet < BaseProgramSheet
    ...
    def housing_outcomes_sheet(sheet)
      ...
      filters = HopwaCaper::Generators::Fy2026::EnrollmentFilters::ExitDestinationFilter.php_destinations
      total_filter = HopwaCaper::Generators::Fy2026::EnrollmentFilters::IncludeFilter.new(label: 'Housing Outcomes for Households Served by this Activity', filters: filters)
      add_household_enrollments_row(
        sheet,
