      ...
      @data_for_destinations ||= begin
        ...
        report_scope.joins(project: :project_cocs).
          ...
          pluck(
            ...
            destination = HudUtilityCurrent.destination_type(destination_id)
            detailed_destination = HudUtilityCurrent.destination(destination_id)
            ...
            destination_buckets.each do |b|
              HudUtilityCurrent.valid_destinations.values.uniq.each do |l|
