      ...
      @data_for_destinations ||= begin
        ...
        report_scope.joins(project: :project_cocs).
          ...
          pluck(
            ...
            destination = HudHelper.util.destination_type(destination_id)
            detailed_destination = HudHelper.util.destination(destination_id)
            ...
            destination_buckets.each do |b|
              HudHelper.util.valid_destinations.values.uniq.each do |l|
