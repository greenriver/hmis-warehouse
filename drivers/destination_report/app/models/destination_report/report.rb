      ...
      @data_for_destinations ||= begin
        ...
        report_scope.joins(project: :project_cocs).
          ...
          pluck(
            ...
            destination = Hud.util.destination_type(destination_id)
            detailed_destination = Hud.util.destination(destination_id)
            ...
            destination_buckets.each do |b|
              Hud.util.valid_destinations.values.uniq.each do |l|
