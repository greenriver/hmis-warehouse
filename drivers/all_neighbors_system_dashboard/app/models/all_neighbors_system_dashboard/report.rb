      ...
      enrollment_scope.preload(
        ...
        batch.each do |enrollment|
          ...
          report_enrollments[enrollment.id] = Enrollment.new(
            ...
            destination_text: HudHelper.util.destination(enrollment.destination),
            ...
            # ethnicity: HudHelper.util.ethnicity(enrollment.client.ethnicity),
      ...
      event_scope.find_in_batches do |batch|
        ...
        batch.each do |event|
          events << enrollment.events.build(
            ...
            event: HudHelper.util.event(event.event),
    ...
    def deduplicate_universe!
      ...
      duplicates = enrollments.
        ...
        group_by do |row|
          ...
          date = if row[:project_type].in?(HudHelper.util.project_types_with_move_in_dates)
            row[:move_in_date]
