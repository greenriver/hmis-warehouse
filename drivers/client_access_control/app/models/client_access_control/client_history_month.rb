...
module ClientAccessControl
  class ClientHistoryMonth
    ...
    def available_project_types(month:, year:, client:, user:)
      ...
      HudUtilityCurrent.project_types.select { |k, _| k.in?(project_types) }
    end
    ...
    def add_project_for_week(projects:, project:, she:, user:)
      ...
      projects[she.id] ||= {
        ...
        project_type_name: HudUtilityCurrent.brief_project_type_with_sub_type(project_type, project.rrh_sub_type),
