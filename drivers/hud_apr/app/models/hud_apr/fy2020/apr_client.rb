...
module HudApr::Fy2020
  class AprClient < ::HudReports::ReportClientBase
    ...
    has_many :hud_report_ce_assessments, class_name: 'HudApr::Fy2020::CeAssessments', foreign_key: :hud_report_apr_client_id, inverse_of: :apr_client
    has_many :hud_report_ce_events, class_name: 'HudApr::Fy2020::CeEvents', foreign_key: :hud_report_apr_client_id, inverse_of: :apr_client
