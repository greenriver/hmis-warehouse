...
module HudApr::Generators::CeApr::Fy2023
  class Generator < ::HudReports::GeneratorBase
    ...
    def self.questions
      [
        HudApr::Generators::CeApr::Fy2023::QuestionFour, # Project Identifiers in HMIS
        HudApr::Generators::CeApr::Fy2023::QuestionFive, # Report Validations
        HudApr::Generators::CeApr::Fy2023::QuestionSix, # Data Quality
        HudApr::Generators::CeApr::Fy2023::QuestionSeven, # Persons Served
        HudApr::Generators::CeApr::Fy2023::QuestionEight, # Households Served
        HudApr::Generators::CeApr::Fy2023::QuestionNine, # Participation in Coordinated Entry
        HudApr::Generators::CeApr::Fy2023::QuestionTen, # Total Coordinated Entry Activity During the Year
      ].map do |q|
        [q.question_number, q]
      end.to_h.freeze
    end
