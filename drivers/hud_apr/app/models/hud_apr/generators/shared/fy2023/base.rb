...
module HudApr::Generators::Shared::Fy2023
  class Base < ::HudReports::QuestionBase
    ...
    # HudApr::Generators::Shared::Fy2023::QuestionFour.new(options: options).run!
      ...
      @generator.client_scope.find_in_batches(batch_size: 100) do |batch|
        ...
        batch.each do |client|
          ...
          options = {
            ...
            client_created_at: source_client.DateCreated || DateTime.current,
            ...
            enrollment_created: enrollment.DateCreated || DateTime.current,
            ethnicity: source_client.Ethnicity,
            exit_created: exit_record&.exit&.DateCreated || DateTime.current,
