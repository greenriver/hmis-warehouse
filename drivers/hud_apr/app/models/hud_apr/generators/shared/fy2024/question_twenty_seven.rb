    ...
    private def q27c_responses
      {
        ...
        'No Single Gender' => a_t[:gender_multi].in(::HudHelper.util('2024').no_single_gender_queries),
        'Questioning' => a_t[:gender_multi].in(::HudHelper.util('2024').questioning_gender_queries),
        'Transgender' => a_t[:gender_multi].in(::HudHelper.util('2024').transgender_gender_queries),
