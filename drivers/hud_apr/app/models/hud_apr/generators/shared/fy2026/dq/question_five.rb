...
module HudApr::Generators::Shared::Fy2026::Dq::QuestionFive
  ...
  included do
    private def generate_q5(table_name)
      ...
      es_sh_so_projects = HudUtility2026.performance_reporting[:es] + HudUtility2026.performance_reporting[:sh] + HudUtility2026.performance_reporting[:so]
      th_projects = HudUtility2026.performance_reporting[:th]
      ph_projects = HudUtility2026.performance_reporting[:ph]
      ce_projects = HudUtility2026.performance_reporting[:ce]
      sso_ds_hp_projects = HudUtility2026.performance_reporting[:services_only] + HudUtility2026.performance_reporting[:day_shelter] + HudUtility2026.performance_reporting[:prevention]
