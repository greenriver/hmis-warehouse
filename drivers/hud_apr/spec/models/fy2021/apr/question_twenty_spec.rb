...
RSpec.describe HudApr::Generators::Apr::Fy2021::QuestionTwenty, type: :model do
  include_context 'apr context FY2021'

  before(:all) do
    default_setup
    run(default_filter, HudApr::Generators::Apr::Fy2021::QuestionTwenty::QUESTION_NUMBER)
  end
