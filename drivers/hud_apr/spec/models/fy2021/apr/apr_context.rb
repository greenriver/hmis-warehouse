...
RSpec.shared_context 'apr context FY2021', shared_context: :metadata do
  ...
  def default_setup
    ...
    if Fixpoint.exists? :hud_hmis_export_2021_app
      ...
      restore_fixpoint :hud_hmis_export_2021_hud_apr_app
      restore_fixpoint :hud_hmis_export_2021_hud_apr_warehouse, connection: warehouse
    else
      setup(default_setup_path)
      store_fixpoint :hud_hmis_export_2021_hud_apr_app
      store_fixpoint :hud_hmis_export_2021_hud_apr_warehouse, connection: warehouse
    end
  end
