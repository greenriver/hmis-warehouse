...
RSpec.describe HudApr::Generators::Apr::Fy2021::QuestionSix, type: :model do
  ...
  describe 'With default project' do
    before(:all) do
      run(default_filter, HudApr::Generators::Apr::Fy2021::QuestionSix::QUESTION_NUMBER)
    end
  ...
  describe 'Q6f: Data Quality: Inactive Records: Street Outreach and Emergency Shelter' do
    before(:all) do
      run(night_by_night_shelter, HudApr::Generators::Apr::Fy2021::QuestionSix::QUESTION_NUMBER)
    end
