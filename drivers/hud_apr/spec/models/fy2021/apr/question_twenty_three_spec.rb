...
RSpec.describe HudApr::Generators::Apr::Fy2021::QuestionTwentyThree, type: :model do
  include_context 'apr context'

  before(:all) do
    default_setup
    run(default_filter, HudApr::Generators::Apr::Fy2021::QuestionTwentyThree::QUESTION_NUMBER)
  end
