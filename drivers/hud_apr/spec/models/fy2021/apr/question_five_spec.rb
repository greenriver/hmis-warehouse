...
RSpec.describe HudApr::Generators::Apr::Fy2021::QuestionFive, type: :model do
  include_context 'apr context FY2021'
  describe 'with default filters' do
    before(:all) do
      default_setup
      run(default_filter, HudApr::Generators::Apr::Fy2021::QuestionFive::QUESTION_NUMBER)
    end
  ...
  describe 'When filtering with a specific race' do
    before(:all) do
      default_setup
      run(race_filter, HudApr::Generators::Apr::Fy2021::QuestionFive::QUESTION_NUMBER)
    end
    it 'counts people served' do
  ...
  describe 'When filtering with a specific age range' do
    before(:all) do
      default_setup
      run(age_filter, HudApr::Generators::Apr::Fy2021::QuestionFive::QUESTION_NUMBER)
    end
    it 'counts people served' do
