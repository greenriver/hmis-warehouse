...
RSpec.describe HudApr::Generators::Caper::Fy2021::QuestionFive, type: :model do
  include_context 'caper context FY2021'

  before(:all) do
    default_setup
    run(default_filter, HudApr::Generators::Caper::Fy2021::QuestionFive::QUESTION_NUMBER)
  end
