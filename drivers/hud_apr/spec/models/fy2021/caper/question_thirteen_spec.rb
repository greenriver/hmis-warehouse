...
RSpec.describe HudApr::Generators::Caper::Fy2021::QuestionThirteen, type: :model do
  include_context 'caper context FY2021'

  before(:all) do
    default_setup
    run(default_filter, HudApr::Generators::Caper::Fy2021::QuestionThirteen::QUESTION_NUMBER)
  end
