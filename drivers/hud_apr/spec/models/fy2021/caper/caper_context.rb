...
RSpec.shared_context 'caper context FY2021', shared_context: :metadata do
  def shared_filter
    {
  ...
  def default_setup
    ...
    if Fixpoint.exists? :hud_hmis_export_2021_app
      ...
      restore_fixpoint :hud_hmis_export_2021_hud_caper_app
      restore_fixpoint :hud_hmis_export_2021_hud_caper_warehouse, connection: warehouse
    else
      setup(default_setup_path)
      store_fixpoint :hud_hmis_export_2021_hud_caper_app
      store_fixpoint :hud_hmis_export_2021_hud_caper_warehouse, connection: warehouse
    end
  end
...
RSpec.configure do |rspec|
  rspec.include_context 'caper context FY2021', include_shared: true
end
