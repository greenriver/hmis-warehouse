...
RSpec.describe HudApr::Generators::CeApr::Fy2020::QuestionSeven, type: :model do
  include_context 'ce apr context'

  describe 'with no assessments' do
    before(:all) do
      default_setup(default_setup_path)
      run(default_filter, HudApr::Generators::CeApr::Fy2020::QuestionSeven::QUESTION_NUMBER)
    end
