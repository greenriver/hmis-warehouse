...
RSpec.shared_context 'caper context', shared_context: :metadata do
  ...
  def default_setup
    ...
    if Fixpoint.exists? :hud_hmis_export_app
      ...
      restore_fixpoint :hud_hmis_export_hud_caper_app
      restore_fixpoint :hud_hmis_export_hud_caper_warehouse, connection: warehouse
    else
      setup(default_setup_path)
      store_fixpoint :hud_hmis_export_hud_caper_app
      store_fixpoint :hud_hmis_export_hud_caper_warehouse, connection: warehouse
    end
  end
