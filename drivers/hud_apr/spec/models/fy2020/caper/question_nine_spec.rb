...
RSpec.describe HudApr::Generators::Caper::Fy2020::QuestionNine, type: :model do
  include_context 'caper context'

  before(:all) do
    default_setup
    run(night_by_night_shelter, HudApr::Generators::Caper::Fy2020::QuestionNine::QUESTION_NUMBER)
  end
