...
RSpec.describe HudApr::Generators::Caper::Fy2020::QuestionTwentyOne, type: :model do
  include_context 'caper context'

  before(:all) do
    default_setup
    run(default_filter, HudApr::Generators::Caper::Fy2020::QuestionTwentyOne::QUESTION_NUMBER)
  end
