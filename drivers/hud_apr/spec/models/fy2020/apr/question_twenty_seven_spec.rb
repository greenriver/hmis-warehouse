...
RSpec.describe HudApr::Generators::Apr::Fy2020::QuestionTwentySeven, type: :model do
  include_context 'apr context'

  before(:all) do
    default_setup
    run(default_filter, HudApr::Generators::Apr::Fy2020::QuestionTwentySeven::QUESTION_NUMBER)
  end
