module Types
  class HmisSchema::ProjectInput < BaseInputObject
    ...
    argument :geocode, String, required: false, validates: { length: { maximum: 6 } }
    argument :address1, String, required: false
    argument :address2, String, required: false
    argument :city, String, required: false
    argument :state, String, required: false, validates: { length: { maximum: 2 } }
    argument :zip, String, required: false, validates: { length: { maximum: 5 } }
