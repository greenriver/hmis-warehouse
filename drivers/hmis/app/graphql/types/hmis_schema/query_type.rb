...
module Types
  class HmisSchema::QueryType < Types::BaseObject
    ...
    field :pick_list, [Types::Forms::PickListOption], 'Get list of options for pick list', null: false do
      ...
      argument :inventory_id, ID, required: false
    end
    def pick_list(pick_list_type:, project_id: nil, inventory_id: nil)
      Types::Forms::PickListOption.options_for_type(pick_list_type, user: current_user, project_id: project_id, inventory_id: inventory_id)
    end
  end
end
