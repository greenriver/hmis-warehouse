...
module Types
  class HmisSchema::Project < Types::BaseObject
    ...
    ce_referrals_field(:ce_referrals, filter_args: { omit: [:project, :project_type, :organization, :on_current_task_since, :workflow_template, :search_term], type_name: 'ProjectCeReferral' })
    ce_referrals_field(:outgoing_direct_ce_referrals, filter_args: { omit: [:on_current_task_since, :workflow_template, :origin, :search_term], type_name: 'ProjectOutgoingCeReferral' })
