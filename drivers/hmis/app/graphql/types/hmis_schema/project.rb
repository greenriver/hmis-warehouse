...
module Types
  class HmisSchema::Project < Types::BaseObject
    ...
    field :occurrence_point_forms, [Types::HmisSchema::OccurrencePointForm], null: false, deprecation_reason: 'Occurrence points should now be resolved on Enrollments', method: :occurrence_point_form_instances, description: 'Forms for individual data elements that are collected at occurrence for this Project (e.g. Move-In Date)'
