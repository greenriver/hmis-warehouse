...
module Types
  class HmisSchema::BulkAssignServiceInput < Types::BaseInputObject
    ...
    argument :coc_code, String, required: false, description: 'CoC code to store as EnrollmentCoC when enrolling a new client. Only needed if Project operates in multiple CoCs.'
