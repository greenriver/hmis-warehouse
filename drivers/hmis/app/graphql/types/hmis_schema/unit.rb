...
module Types
  class HmisSchema::Unit < Types::BaseObject
    ...
    ce_referrals_field :ce_referrals, null: false,
                                      description: 'All current and historical CE referrals for the unit',
                                      filter_args: {
                                        omit: [:assigned_to_user, :project, :organization, :project_group_id, :project_type, :workflow_template],
                                        type_name: 'UnitCeReferral',
                                      }
