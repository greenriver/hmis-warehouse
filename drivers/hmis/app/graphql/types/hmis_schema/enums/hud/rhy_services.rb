...
module Types
  class HmisSchema::Enums::Hud::RHYServices < Types::BaseEnum
    description '4.14.B'
    ...
    value POST_NATAL_CARE, '(12) Post-natal care', value: 12
    ...
    value POST_NATAL_NEWBORN_CARE_WELLNESS_EXAMS_IMMUNIZATIONS, '(27) Post-natal newborn care (wellness exams; immunizations)', value: 27
