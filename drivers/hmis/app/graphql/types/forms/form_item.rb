...
module Types
  class Forms::FormItem < Types::BaseObject
    ...
    field :required, Boolean, 'Whether the item must be included in data results', null: false, default_value: false
    field :warn_if_empty, Boolean, 'Whether to show a warning if this question is unanswered', null: false, default_value: false
    ...
    field :prefill, Boolean, 'Whether to allow pre-filling this section from a previous assessment', null: false, default_value: false
    ...
    field :hidden, Boolean, 'Whether the item should always be hidden', null: false, default_value: false
    field :read_only, Boolean, 'Whether human editing is allowed', null: false, default_value: false
    field :hide_when_viewing, Boolean, 'Whether to hide the item when form is in view-mode', null: false, default_value: false
    field :hide_when_editing, Boolean, 'Whether to hide the item when form is in view-mode', null: false, default_value: false
    field :repeats, Boolean, 'Whether the item may repeat (for choice types, this means multiple choice)', null: false, default_value: false
    ...
    field :disabled_display, Forms::Enums::DisabledDisplay, 'How to display item if it is disabled', null: false, default_value: 'HIDDEN'
    field :size, Forms::Enums::InputSize, 'Size of the input element', null: true
    field :enable_behavior, Forms::Enums::EnableBehavior, null: false, default_value: 'ANY'
