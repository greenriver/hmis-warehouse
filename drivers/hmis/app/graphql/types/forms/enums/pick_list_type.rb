...
module Types
  class Forms::Enums::PickListType < Types::BaseEnum
    ...
    value 'FORM_TYPES', 'Form types visible in the Forms admin tool'
    value 'CREATABLE_FORM_TYPES', 'Form types that the user can create'
