...
module Mutations
  class Ce::CreateDirectCeReferral < CleanBaseMutation
    ...
    argument :form_definition_id, ID, required: true # The form that was used to submit the first referral step
    ...
    def resolve(target_unit_group_id:, source_enrollment_id:, values_by_link_id:, values_by_field_name:, form_definition_id:, confirmed: false)
      ...
      opportunity.with_lock do
        ...
        raise "No workflow template configured. Opportunity: #{opportunity.id}" unless workflow_template
