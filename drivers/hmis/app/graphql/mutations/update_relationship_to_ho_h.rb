...
module Mutations
  class UpdateRelationshipToHoH < BaseMutation
    ...
    argument :enrollment_version, Integer, required: false
    ...
    def resolve(enrollment_id:, enrollment_version:, relationship_to_ho_h:, confirmed: false)
      enrollment = Hmis::Hud::Enrollment.viewable_by(current_user).find_by(id: enrollment_id)
      enrollment.lock_version = enrollment_version if enrollment_version
