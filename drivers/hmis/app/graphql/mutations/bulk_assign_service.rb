...
module Mutations
  class BulkAssignService < CleanBaseMutation
    ...
    def resolve(input:)
      ...
      access_denied! unless current_user.permissions_for?(project, :can_edit_enrollments, :can_view_enrollment_details, mode: :all) # TODO replace with policy check against project policy
