...
class Hmis::Form::Definition < ::GrdaWarehouseBase
  ...
  # Form roles that can appear in the Forms admin tool; see the configurable_by scope
  use_enum_with_same_key :configurable_form_role_enum_map, FORM_ROLES.excluding(*NON_CONFIGURABLE_FORM_ROLES)
