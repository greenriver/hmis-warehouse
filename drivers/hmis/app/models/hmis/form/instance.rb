...
class Hmis::Form::Instance < ::GrdaWarehouseBase
  ...
  validates :funder, inclusion: { in: HudUtilityCurrent.funding_sources.keys }, allow_blank: true
  validates :project_type, inclusion: { in: HudUtilityCurrent.project_types.keys }, allow_blank: true
