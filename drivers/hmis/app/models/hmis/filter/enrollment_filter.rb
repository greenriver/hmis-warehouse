...
class Hmis::Filter::EnrollmentFilter < Hmis::Filter::BaseFilter
  ...
  def with_household_tasks(scope)
    with_filter(scope, :household_tasks) do
      ...
      # Clause for checking whether an Enrollment's Entry Date falls before the "anniversary". There are two cases because the anniversary may be this year or last year.
