...
class Hmis::Hud::Household < Hmis::Hud::Base
  ...
  replace_scope :viewable_by, ->(user) do
    ...
    projects = Hmis::Hud::Project.with_access(user, :can_view_enrollment_details, :can_view_project, mode: :all).where(cond) # TODO replace with shared scope `with_full_enrollment_detail_visibility`
