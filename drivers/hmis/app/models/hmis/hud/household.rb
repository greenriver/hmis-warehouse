...
class Hmis::Hud::Household < Hmis::Hud::Base
  ...
  has_many :staff_assignments, -> { order(created_at: :desc, id: :desc) }, class_name: 'Hmis::StaffAssignment', primary_key: [:data_source_id, :HouseholdID], query_constraints: [:data_source_id, :household_id]
