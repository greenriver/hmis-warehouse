...
#
# The table structure is based on the `User.csv` specification. The `UserID` column in this table is used to associate
# data in other CSV-structured tables with a specific user. Generally it represents the user who most recently updated the record.
#
