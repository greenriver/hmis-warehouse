...
class Hmis::Hud::Enrollment < Hmis::Hud::Base
  ...
  # HUD services
  has_many :services, primary_key: :enrollment_slug, foreign_key: :enrollment_slug, class_name: 'Hmis::Hud::Service', inverse_of: :enrollment, dependent: :destroy
  has_many :bed_nights, -> { bed_nights }, **hmis_enrollment_relation('Service')
  # Custom services
  has_many :custom_services,  primary_key: :enrollment_slug, foreign_key: :enrollment_slug, class_name: 'Hmis::Hud::CustomService', inverse_of: :enrollment, dependent: :destroy
  ...
  has_many :hmis_services,  primary_key: :enrollment_slug, foreign_key: :enrollment_slug, class_name: 'Hmis::Hud::HmisService', inverse_of: :enrollment
  has_many(
    :move_in_addresses,
