...
class Hmis::StaffAssignment < Hmis::HmisBase
  ...
  belongs_to :household, class_name: 'Hmis::Hud::Household', primary_key: [:data_source_id, :HouseholdID], query_constraints: [:data_source_id, :household_id], inverse_of: :staff_assignments
