...
RSpec.describe Hmis::UsersController, type: :request do
  ...
  describe 'GET /hmis/user.json' do
    context 'when authenticated' do
      ...
      # Under jwt the sign-in helper attaches a connector, so primaryIdp is populated rather than nil.
      ...
      # Hmis::User reports Devise.timeout_in on both arms (drivers/hmis/app/models/hmis/user.rb:255),
