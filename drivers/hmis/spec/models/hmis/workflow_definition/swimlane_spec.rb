...
RSpec.describe Hmis::WorkflowDefinition::Swimlane, type: :model do
  include_context 'hmis base setup'

  let(:build_record) do
    -> { create(:hmis_workflow_definition_swimlane, template: create(:hmis_workflow_definition_template, data_source: ds1)) }
  end
