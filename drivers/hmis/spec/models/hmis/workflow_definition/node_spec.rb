...
RSpec.describe Hmis::WorkflowDefinition::Node, type: :model do
  include_context 'hmis base setup'

  let(:build_record) do
    -> { create(:hmis_workflow_definition_start_event, template: create(:hmis_workflow_definition_template, data_source: ds1)) }
  end
