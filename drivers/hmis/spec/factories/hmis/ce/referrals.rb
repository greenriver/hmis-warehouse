...
FactoryBot.define do
  factory :hmis_ce_referral, class: 'Hmis::Ce::Referral' do
    ...
    transient do
      ...
      target_project { build :hmis_hud_project, data_source: data_source }
      workflow_template { build :hmis_workflow_definition_template, data_source: data_source }
    end

    opportunity { association :hmis_ce_opportunity, project: target_project, workflow_template: workflow_template, data_source: data_source }
