...
- Don't create a form definition where all questions are ruled out for a given project context by custom item rules.
  - If we ever do this, and then enable the form in such a project, we see an error like this: https://greenriver.slack.com/archives/C061SAW3LFJ/p1733158338135599
