...
module HmisUtil
  class ServiceTypes
    ...
    R14_RHY_SERVICE_CONFIG = {
      ...
      funders: HudHelper.util.funding_sources.select { |_, v| v.start_with?('HHS: RHY') }.keys - [25] + [43],
    }.freeze
    ...
    W1_HOPWA_SERVICE_CONFIG = {
      ...
      # ],
      funders: HudHelper.util.funding_sources.select { |_, v| v.start_with?('HUD: HOPWA') }.keys,
    }.freeze
    ...
    V2_SSVF_SERVICE_CONFIG = {
      ...
      funders: HudHelper.util.funding_sources.select { |_, v| v.start_with?('VA:') }.keys,
    }.freeze
