...
module HmisUtil
  class ServiceTypes
    ...
    def self.seed_hud_service_types(data_source_id)
      ...
      HudUtilityCurrent.record_types.each do |record_type, category_name|
    ...
    R14_RHY_SERVICE_CONFIG = {
      ...
      funders: HudUtilityCurrent.funding_sources.select { |_, v| v.start_with?('HHS: RHY') }.keys - [25] + [43],
    }.freeze
    ...
    W1_HOPWA_SERVICE_CONFIG = {
      ...
      # ],
      funders: HudUtilityCurrent.funding_sources.select { |_, v| v.start_with?('HUD: HOPWA') }.keys,
    }.freeze
    ...
    V2_SSVF_SERVICE_CONFIG = {
      ...
      funders: HudUtilityCurrent.funding_sources.select { |_, v| v.start_with?('VA:') }.keys,
    }.freeze
