...
module CePerformance
  class Results::ExitInstitutional < CePerformance::Result
    ...
    def self.client_scope(report, period)
      report.clients.served_in_period(period).
        ...
        institutional_exit_destination
    end
    ...
    def description
      'Count of clients exiting to an Institutional Situation.'
    end

    def self.calculation
      'Count of clients exiting from CE to an Institutional Situation during report period.'
    end
