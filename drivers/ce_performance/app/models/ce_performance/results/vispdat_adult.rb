...
module CePerformance
  class Results::VispdatAdult < CePerformance::Result
    ...
    def self.title
      'Average Single Housing Needs Assessment Score'
    end
    ...
    def description
      'Average Single Housing Needs Assessment score for clients enrolled during the report period.'
    end

    def self.calculation
      'The average of the most recent Single Housing Needs Assessment scores collected before the end of the report period for clients enrolled during the reporting period.'
    end
