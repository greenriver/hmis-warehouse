...
module CePerformance
  class Results::ExitOther < CePerformance::Result
    ...
    def description
      'Count of clients exiting to Other.'
    end

    def self.calculation
      'Count of clients exiting from CE to Other Situations during report period.'
    end
