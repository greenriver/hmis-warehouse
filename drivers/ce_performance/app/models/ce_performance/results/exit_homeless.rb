...
module CePerformance
  class Results::ExitHomeless < CePerformance::Result
    ...
    def description
      'Count of clients exiting to a Homeless Situation.'
    end

    def self.calculation
      'Count of clients exiting from CE to a Homeless Situation during report period.'
    end
