...
module CePerformance
  class Results::ExitTemporary < CePerformance::Result
    ...
    def description
      'Count of clients exiting to an Temporary Housing Situation.'
    end

    def self.calculation
      'Count of clients exiting from CE to a Temporary Housing Situation during report period.'
    end
