...
module HudLists2024
  ...
  # 2.08.1
  def hmis_participation_type_map
    {
      0 => 'Not Participating',
  ...
  # 3.917
  def prior_living_situation_map
    {
      8 => "Client doesn't know",
      9 => 'Client prefers not to answer',
      35 => "Staying or living in a family member's room, apartment or house",
  ...
  def hud_code_to_function_map
    {
      ...
      "2.02.7": :target_population_map,
      "2.02.8": :hopwa_med_assisted_living_fac_map,
      "2.02.A": :rrh_sub_type_map,
      ...
      "2.08.1": :hmis_participation_type_map,
      ...
      "3.12": :destination_map,
      "3.12.A": :rental_subsidy_type_map,
      "3.15.1": :relationship_to_ho_h_map,
      "3.6.1": :gender_map,
      "3.917": :prior_living_situation_map,
      ...
      "4.21.6": :service_provided_map,
      "4.21.A": :prevention_outcome_map,
      "4.21.E": :shelter_outcome_map,
      "4.21.I": :housing_outcome_map,
      "4.21.M": :service_outcome_map,
      ...
      "V3.3": :ssvf_financial_assistance_map,
