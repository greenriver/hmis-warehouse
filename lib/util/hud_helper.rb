...
#   HudHelper.util.gender('1') # => "Female"
#
# @example Explicit version
#   # Use specific version
#   legacy_util = HudHelper.util('legacy')
#   current_util = HudHelper.util('2026')
#
# @see HudUtility2026
# @see HudUtility2024
...
module HudHelper
  ...
  class << self
    ...
    # @example
    #   HudHelper.util('2026') #=> HudUtility2026
    #   HudHelper.util         #=> Returns current version utility based on environment
