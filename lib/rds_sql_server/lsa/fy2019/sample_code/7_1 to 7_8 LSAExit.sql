...
*/
	...
	inner join (select n.HouseholdID, hhid.ExitCohort, max(
		case
		when c.VeteranStatus = 1 and hhid.ExitCohort = 0 and n.ActiveAge between 18 and 65
		  or c.VeteranStatus = 1 and hhid.ExitCohort = -1 and n.Exit1Age between 18 and 65
		  or c.VeteranStatus = 1 and hhid.ExitCohort = -2 and n.Exit2Age between 18 and 65
		then
      1
		else
		  0
		...
		-- where case hhid.ExitCohort -- FIXME: This change leaves HHVet NULL
