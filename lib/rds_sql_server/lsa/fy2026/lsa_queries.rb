  ...
  class LSAQueries
    ...
    def steps
      @steps ||= [
        ...
        'lib/rds_sql_server/lsa/fy2026/sample_code/05_01 to 05_11 LSAPerson Records and Demographics.sql',
        'lib/rds_sql_server/lsa/fy2026/sample_code/05_12 to 05_15 LSAPerson Project Group and Population Household Types.sql',
    ...
    def setup_test_projects
      step = 'lib/rds_sql_server/lsa/fy2026/sample_code/04_01 Get Project Records.sql'
      run_query(step)
    end
