...
module LsaSqlServer
  class LSAQueries
    ...
    def steps
      @steps ||= [
        'lib/rds_sql_server/lsa/fy2027/sample_code/03_02 to 03_06 HMIS Households and Enrollments.sql',
        'lib/rds_sql_server/lsa/fy2027/sample_code/04_01 Get Project Records.sql',
        'lib/rds_sql_server/lsa/fy2027/sample_code/04_02 to 04_07 Get Other PDDEs.sql',
        'lib/rds_sql_server/lsa/fy2027/sample_code/05_01 to 05_11 LSAPerson Records and Demographics.sql',
        'lib/rds_sql_server/lsa/fy2027/sample_code/05_12 to 05_15 LSAPerson Project Group and Population Household Types.sql',
        'lib/rds_sql_server/lsa/fy2027/sample_code/06 LSAHousehold.sql',
        'lib/rds_sql_server/lsa/fy2027/sample_code/07 LSAExit.sql',
        'lib/rds_sql_server/lsa/fy2027/sample_code/08 LSACalculated Averages for LSAHousehold and LSAExit.sql',
        'lib/rds_sql_server/lsa/fy2027/sample_code/09 LSACalculated AIR Counts.sql',
        'lib/rds_sql_server/lsa/fy2027/sample_code/10 LSACalculated Data Quality.sql',
        'lib/rds_sql_server/lsa/fy2027/sample_code/11 LSAReport DQ and ReportDate.sql',
      ]
    end
    ...
    def setup_test_projects
      step = 'lib/rds_sql_server/lsa/fy2027/sample_code/04_01 Get Project Records.sql'
      run_query(step)
    end
