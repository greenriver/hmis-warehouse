...
*/
	...
	create nonclustered index ix_hmis_Enrollment_DateDeleted_RelationshipToHoH on hmis_Enrollment (DateDeleted, RelationshipToHoH) include (EnrollmentID, PersonalID, EntryDate, HouseholdID, DisablingCondition)
	...
	create nonclustered index ix_hmis_EnrollmentCoC_EnrollmentID_InformationDate_DateDeleted on hmis_EnrollmentCoC (EnrollmentID, InformationDate, DateDeleted) include (CoCCode)

	create nonclustered index ix_hmis_EnrollmentCoC_DateDeleted_InformationDate on hmis_EnrollmentCoC (DateDeleted, InformationDate) include (HouseholdID, CoCCode)
