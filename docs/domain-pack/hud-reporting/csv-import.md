...
- `app/models/grda_warehouse/hmis_import_config.rb`: S3 credentials, `possible_files`, and
  `zip_file_password` (validated against `ZipCloak::MAX_PASSWORD_LENGTH`/`CONTROL_CHARACTERS`).
