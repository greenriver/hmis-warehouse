...
| --- | --- | --- | --- |
| 1 | **Extensibility & Local Configuration** | HUD publishes revised HMIS Data Standards, and a community asks for a data element and a Coordinated Entry assessment of its own. Engineers take on the HUD change by adding its fields and writing a driver for the new specification year, leaving existing reports alone; an administrator sets up what the community asked for as configuration, with no change to core domain models. | [Q-1–Q-6](10-quality.md#102-quality-scenarios) |
