...
- **Modular Feature Drivers**: Large features are isolated as self-contained module directories under `/drivers/` (a convention autoloaded into the monolith, not Rails engines). See [8.3 Driver Module Pattern](08-concepts/08-3-driver-module-pattern.md) and the [driver catalog](05-building-blocks/05-2-1-warehouse.md).
