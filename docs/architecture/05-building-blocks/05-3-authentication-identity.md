...
[← 5.2 Data Ingestion & Analytics](05-2-data-ingestion-analytics.md) | [Table of Contents](../README.md) | [Next: 5.4 Warehouse Application →](05-4-warehouse-application.md)

This view focuses on the authentication layer, identity brokering, and user management (C4 Level 3).
