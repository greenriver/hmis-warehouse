...
| **Driver Module Pattern** | Features are isolated as self-contained module directories under `/drivers/`. See [8.3 Driver Module Pattern](08-concepts/08-3-driver-module-pattern.md). |
