...
| ID | Stimulus | Context | Metric |
| --- | --- | --- | --- |
| Q-21 | Front-line staff load and use the HMIS data-entry interface. | Peak intake hours, with imports and large reports running in the background. | The data-entry interface stays available and responsive; background work and planned maintenance do not impede HMIS operation. |
