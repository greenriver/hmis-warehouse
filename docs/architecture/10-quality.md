...
| Goal 2 | **Data Integrity & Auditability** | #reliable #suitable | Warehouse records and report figures are traceable to their contributing source records, and remain so after the underlying data changes: source data is preserved in its original form, deletions are reversible, and superseded report logic is retained. Goal — see [§1.2](01-introduction.md#12-quality-goals); [Q-7–Q-13](#data-integrity--auditability-reliable-suitable). |
